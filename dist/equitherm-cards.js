 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1={ATTRIBUTE:1},e$1=t=>(...e)=>({_$litDirective$:t,values:e});class i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i;}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
 ...
 */
class EquithermBaseCard extends i$1 {
    constructor() {
        super(...arguments);
        // === Action Handling ===
...
let ActionBadge = class ActionBadge extends i$1 {
    constructor() {
        super(...arguments);
        this.action = 'idle';
    }
    ...
    render() {
      ...
      <ha-card>
        <div class="header">
          ...
          ` : A}
          ${this._controlMode ? b `<span class="mode" @click=${() => this._openMoreInfo(this._config.control_mode_entity)}>${this._controlMode}</span>` : A}
        </div>
 ...
 */
let ShapeIcon = class ShapeIcon extends i$1 {
    constructor() {
        super(...arguments);
        this.shape = 'circle';
        this.size = 40;
...
__decorate([
    n()
], ShapeIcon.prototype, "color", void 0);
__decorate([
    n({ attribute: 'bg-color' })
], ShapeIcon.prototype, "bgColor", void 0);
__decorate([
    n()
...
let StatusCardEditor = class StatusCardEditor extends i$1 {
    constructor() {
        super(...arguments);
        this._schema = [
            // Required entities
...
let EquithermCurveCardEditor = class EquithermCurveCardEditor extends i$1 {
    constructor() {
        super(...arguments);
...
EquithermCurveCardEditor.styles = i$4 `

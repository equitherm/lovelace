 ...
 */
const t$4=globalThis,e$6=t$4.ShadowRoot&&(void 0===t$4.ShadyCSS||t$4.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s$2=Symbol(),o$5=new WeakMap;let n$4 = class n{constructor(t,e,o){if(this._$cssResult$=true,o!==s$2)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e;}get styleSheet(){let t=this.o;const s=this.t;if(e$6&&void 0===t){const e=void 0!==s&&1===s.length;e&&(t=o$5.get(s)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&o$5.set(s,t));}return t}toString(){return this.cssText}};const r$5=t=>new n$4("string"==typeof t?t:t+"",void 0,s$2),i$5=(t,...e)=>{const o=1===t.length?t[0]:e.reduce((e,s,o)=>e+(t=>{if(true===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[o+1],t[0]);return new n$4(o,t,s$2)},S$1=(s,o)=>{if(e$6)s.adoptedStyleSheets=o.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const e of o){const o=document.createElement("style"),n=t$4.litNonce;void 0!==n&&o.setAttribute("nonce",n),o.textContent=e.cssText,s.appendChild(o);}},c$2=e$6?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return r$5(e)})(t):t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1={ATTRIBUTE:1},e$1=t=>(...e)=>({_$litDirective$:t,values:e});let i$1 = class i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i;}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};
 ...
 */
function entitiesChanged(prev, next, entityIds) {
    if (!prev)
        return true;
    return entityIds
        .filter((id) => !!id)
 ...
 */
function applyDarkMode(element, hass) {
...
var curve_card$1 = {
	...
	flow_temp: "Flow Temp",
	outdoor_axis: "°C outdoor",
	flow_axis: "°C flow",
	outdoor_tooltip: "{temp}°C outdoor",
	flow_tooltip: "{temp}°C flow"
};
var editor$1 = {
	required: "Required",
	optional: "Optional",
...
var curve_card = {
	...
	outdoor_axis: "°C extérieur",
	flow_axis: "°C départ",
	outdoor_tooltip: "{temp}°C extérieur",
	flow_tooltip: "{temp}°C départ"
};
var editor = {
	required: "Requis",
	optional: "Optionnel",
...
// src/localize.ts
const translations = { en: en$1, fr: fr$1 };
let cachedLang = null;
 ...
 */
class EquithermBaseCard extends i$2 {
    constructor() {
        super(...arguments);
        // === Action Handling ===
...
__decorate([
    r$1()
], EquithermBaseCard.prototype, "_hass", void 0);
__decorate([
    r$1()
], EquithermBaseCard.prototype, "_config", void 0);
...
// Layout options
const LAYOUTS = ['default', 'vertical', 'horizontal'];
const LayoutStruct = optional(enums(LAYOUTS));
// Info display options
const INFOS = ['name', 'state', 'last-changed', 'last-updated', 'none'];
const InfoStruct = optional(enums(INFOS));
// Icon type options
const ICON_TYPES = ['icon', 'entity-picture', 'none'];
const IconTypeStruct = optional(enums(ICON_TYPES));
 ...
 */
function getIconStyleVars(action) {
...
function getActionBadgeIcon(action) {
 ...
 */
let ShapeIcon = class ShapeIcon extends i$2 {
    constructor() {
        super(...arguments);
        this.shape = 'circle';
        this.size = 40;
    ...
    render() {
        return b `
      <div
        class=${e({ shape: true, disabled: this.disabled })}
...
__decorate([
    n$1()
], ShapeIcon.prototype, "shape", void 0);
__decorate([
    n$1({ type: Number })
], ShapeIcon.prototype, "size", void 0);
__decorate([
    n$1({ type: Boolean })
 ...
 */
let BadgeIcon = class BadgeIcon extends i$2 {
    constructor() {
        super(...arguments);
        this.icon = '';
    }
    render() {
        return b `<ha-icon .icon=${this.icon}></ha-icon>`;
    }
};
BadgeIcon.styles = i$5 `
    :host {
      --badge-size: 16px;
...
let EquithermStatusCard = class EquithermStatusCard extends EquithermBaseCard {
    ...
    static getStubConfig() {
        return { type: 'custom:equitherm-status-card' };
    }
    ...
    setConfig(config) {
        if (!config.climate_entity)
            throw new Error('climate_entity is required');
        if (!config.outdoor_entity)
            throw new Error('outdoor_entity is required');
        if (!config.flow_entity)
            throw new Error('flow_entity is required');
    ...
    get _outdoorTemp() {
        ...
        if (!state)
            return '—';
        return this._formatTemp(parseFloat(state.state), this._entityAttr(this._config.outdoor_entity, 'unit_of_measurement'));
    }
    get _flowTemp() {
        const state = this._entityState(this._config.flow_entity);
        if (!state)
            return '—';
        return this._formatTemp(parseFloat(state.state), this._entityAttr(this._config.flow_entity, 'unit_of_measurement'));
    }
    get _roomTemp() {
    ...
    get _rateLimitingActive() {
        return this._entityState(this._config.rate_limiting_entity)?.state === 'on';
    }
    get _adjustingDirection() {
        if (!this._rateLimitingActive || !this._config.curve_output_entity)
            return null;
    ...
    get _curveOutputTemp() {
        ...
        if (isNaN(value))
            return '';
        return this._formatTemp(value, this._entityAttr(this._config.curve_output_entity, 'unit_of_measurement'));
    }
    render() {
        ...
        const title = this._config.title ?? this._entityAttr(this._config.climate_entity, 'friendly_name') ?? localize('status_card.default_title');
        // Use centralized color utilities
        const badgeIcon = getActionBadgeIcon(hvacAction);
        const iconStyles = o(getIconStyleVars(hvacAction));
        return b `
      <ha-card>
        <div class="header">
          <eq-shape-icon
        ...
        <div class=${e({ temps: true, vertical: layout === 'vertical', horizontal: layout === 'horizontal' })}>
...
], EquithermStatusCard.prototype, "layout", void 0);
EquithermStatusCard = __decorate([
    t$2('equitherm-status-card')
], EquithermStatusCard);
...
let ActionBadge = class ActionBadge extends i$2 {
    constructor() {
        super(...arguments);
        this.action = 'idle';
    }
...
__decorate([
    n$1()
], ActionBadge.prototype, "action", void 0);
ActionBadge = __decorate([
    t$2('eq-action-badge')
], ActionBadge);
...
let EquithermCurveCard = class EquithermCurveCard extends EquithermBaseCard {
    constructor() {
        super(...arguments);
    ...
    get _tOutdoorUnit() {
        return this._entityAttr(this._config.outdoor_entity, 'unit_of_measurement');
    }
    get _flowTemp() {
    ...
    get _flowTempUnit() {
        return this._entityAttr(this._config.flow_entity, 'unit_of_measurement');
    }
    get _rateLimitingActive() {
        if (!this._config.rate_limiting_entity)
            return false;
        return this._entityState(this._config.rate_limiting_entity)?.state === 'on';
    }
    _buildChartOptions() {
        ...
        return {
            ...
            series: [
                {
                    ...
                    data: curveSeries.map((p) => ({ x: -p.x, y: p.y })),
                },
            ],
            ...
            tooltip: {
                x: { formatter: (v) => localize('curve_card.outdoor_tooltip', { temp: (-v).toFixed(1) }) },
                y: { formatter: (v) => localize('curve_card.flow_tooltip', { temp: v.toFixed(1) }) },
            },
        };
    }
    async firstUpdated() {
    ...
    _initChart() {
        if (this._chartInitialized)
            return;
        this._chart = new ApexCharts$1(this._chartEl, this._buildChartOptions());
        this._chart.render();
    ...
    _structuralParamsChanged(prev, next) {
        if (!prev)
            return true;
        const keys = ['hc', 'n', 'shift', 'min_flow', 'max_flow', 't_out_min', 't_out_max'];
        return keys.some(key => prev[key] !== next[key]);
    }
    updated(changedProps) {
        if (changedProps.has('_config') && this._chart) {
            const prevConfig = changedProps.get('_config');
    ...
    render() {
        ...
        const title = this._config.title ?? this._entityAttr(this._config.climate_entity, 'friendly_name') ?? localize('curve_card.default_title');
        return b `
      <ha-card>
        <div class="header">
          <span class="title">${title}</span>
...
__decorate([
    e$2('#chart')
], EquithermCurveCard.prototype, "_chartEl", void 0);
__decorate([
    e$2('.chart-wrapper')
], EquithermCurveCard.prototype, "_chartWrapper", void 0);
EquithermCurveCard = __decorate([
    t$2('equitherm-curve-card')
], EquithermCurveCard);
...
console.info('%c EQUITHERM-CARDS %c 1.0.1 ', 'color: white; background: #f97316; font-weight: bold;', 'color: #f97316; background: white; font-weight: bold;');
...
let StatusCardEditor = class StatusCardEditor extends i$2 {
    constructor() {
        super(...arguments);
        this._schema = [
            // Title
...
__decorate([
    n$1({ attribute: false })
], StatusCardEditor.prototype, "hass", void 0);
__decorate([
    r$1()
], StatusCardEditor.prototype, "_config", void 0);
StatusCardEditor = __decorate([
    t$2('equitherm-status-card-editor')
], StatusCardEditor);
...
function number(name, min, max, step = 1, mode = 'slider') {
    return {
        name,
        required: true,
...
EquithermCurveCardEditor.styles = i$5 `
...
__decorate([
    n$1({ attribute: false })
], EquithermCurveCardEditor.prototype, "hass", void 0);
__decorate([
    r$1()
], EquithermCurveCardEditor.prototype, "_config", void 0);
EquithermCurveCardEditor = __decorate([
    t$2('equitherm-curve-card-editor')

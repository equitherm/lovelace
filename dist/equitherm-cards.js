...
`;class tr extends qi{constructor(){super(...arguments),this._showTuningDialog=!1,this._openTuningDialog=()=>{this._showTuningDialog=!0},this._onDeltaParamChanged=t=>{const e=t.target.dataset.entityId;if(!e||!this.hass)return;const i=this._fromDisplayDelta(t.detail.value);this.hass.callService(It(e),"set_value",{entity_id:e,value:i})},this._onParamChanged=t=>{const e=t.target.dataset.entityId;e&&this.hass&&this.hass.callService(It(e),"set_value",{entity_id:e,value:t.detail.value})}}get _climate(){return this._entityState(this._config.climate_entity)}get _isManualPreset(){return"Manual"===this._climate?.attributes.preset_mode}updated(t){super.updated(t),t.has("hass")&&this.hass&&this.toggleAttribute("manual-override",this._isManualPreset)}get _roomTemp(){const t=this._climate?.attributes.current_temperature;return this._formatCalcTemp(t)}get _outdoorTempFormatted(){return this._formatEntityTemp(this._config.outdoor_entity)}get _flowTempFormatted(){return this._formatEntityTemp(this._config.flow_entity)}get _curveOutputTempFormatted(){const t=Yi(this._config);return t?this._formatEntityTemp(t):""}get _isWWSD(){if(this._config?.wws_entity){const t=this._entityState(this._config.wws_entity);return"on"===t?.state}if(!this._config?.climate_entity)return!1;const t=this._climate?.attributes.temperature;if(null==t)return!1;if(!this._config.outdoor_entity)return!1;const e=this._entityState(this._config.outdoor_entity);if(!e)return!1;const i=parseFloat(e.state),r=isNaN(i)?NaN:this._fromDisplayTemp(i);return!isNaN(r)&&r>=t}_wwsdDescription(){const t=Ui(this.hass),e=this._climate?.attributes.temperature,i=this._config.outdoor_entity,r=i?this._entityState(i):void 0,n=r?this._fromDisplayTemp(parseFloat(r.state)):NaN;return isNaN(n)||null==e?t("common.wwsd_label"):`${t("common.outdoor")} ${this._formatEntityTemp(i)} ≥ ${this._formatCalcTemp(e)}`}_renderNotFound(t,e){if(!t||this._entityExists(t))return V;const i=Ui(this.hass);return z`
    ...
    `}_renderPidBadge(){const t=this._config;if(!t.pid_active_entity)return V;const e=function(t,e){return!!t.pid_active_entity&&"on"===e(t.pid_active_entity)?.state}(t,t=>this._entityState(t));return z`
      ...
      ></eq-badge-info>
    `}_renderWwsdBadge(){if(!this._isWWSD)return V;const t=Ui(this.hass);return z`
      <eq-badge-info
        id="wwsd-badge"
        .label=${t("common.wwsd")}
    ...
    `}_renderManualBadge(){if(!this._isManualPreset)return V;const t=Ui(this.hass);return z`
      <eq-badge-info
        .label=${t("common.manual")}
        style=${"--badge-info-color: var(--rgb-warning, 255, 167, 38)"}
        .icon=${"mdi:hand-back-right"}
      ></eq-badge-info>
    `}_renderHvacBadge(){const t=Ui(this.hass),e=ji(this._climate?.attributes.hvac_action??"off"),i=t=>this._entityState(t),r=this._config,n=function(t,e,i=!1,r=null){if(i){const e="rising"===r?"mdi:trending-up":"falling"===r?"mdi:trending-down":"mdi:trending-neutral";return{label:t("common.adjusting"),color:Vi("heating"),icon:e,active:!0}}return{label:t({heating:"common.heating",cooling:"common.cooling",drying:"common.drying",idle:"common.idle",off:"common.off",fan:"common.fan",defrosting:"common.defrosting",preheating:"common.preheating"}[e]),color:Vi(e),icon:zi(e)??void 0,active:Wi.has(e)}}(t,e,Ki(r,i),Zi(r,i));return z`
      <eq-badge-info
        .label=${n.label}
    ...
    `}_renderKpiFooter(t){if(!1===this._config.show_kpi_footer)return V;if(!this._config||!this.hass)return V;const e=Ui(this.hass),i=t?.outdoorClickEntity??this._config.outdoor_entity,r=!this._entityExists(i),n=!this._entityExists(this._config.flow_entity),o=!this._entityExists(this._config.climate_entity);return z`
...
const er=Nt(class extends Pt{constructor(t){if(super(t),t.type!==Ht||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const r=!!e[t];r===this.st.has(t)||this.nt?.has(t)||(r?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return j}});class ir extends tr{getGridOptions(){return{columns:12,rows:"auto",min_rows:3}}getCardSize(){return 3}get _hasFixedHeight(){const t=this._config?.grid_options,e=t?.rows;return"number"==typeof e}_formatChartTime(t){return ne(new Date(t),this.hass.locale,this.hass.config)}_formatChartDateTime(t){const e=new Date(t);return`${e.toLocaleDateString(this.hass?.locale?.language,{weekday:"short"})} ${ne(e,this.hass.locale,this.hass.config)}`}_updateChartConfig(){this._config&&this.hass&&(this._echartConfig=this._buildEChartOptions())}updated(t){if(super.updated(t),t.has("hass")){const e=t.get("hass"),i=e&&this.hass?.config?.unit_system?.temperature!==e.config?.unit_system?.temperature,r=e&&this.hass?.locale?.time_format!==e.locale?.time_format;(i||r)&&this._updateChartConfig()}}_onChartReconnected(){}_onChartDisconnecting(){}connectedCallback(){super.connectedCallback(),this._config&&this.hass&&this._onChartReconnected()}disconnectedCallback(){this._onChartDisconnecting(),super.disconnectedCallback()}_renderChart(){if(!this._echartConfig)return V;const{options:t,data:e}=this._echartConfig;return z`
  ...
  `,t([pt({attribute:!1})],rr.prototype,"hass",void 0),t([mt()],rr.prototype,"_config",void 0),t([mt()],rr.prototype,"_error",void 0);const nr=a`
  :host {
...
`;function lr(t){const e=window;e.customCards=e.customCards||[];const i=t.type.replace("-card","").replace("equitherm-","");e.customCards.push({...t,preview:!0,documentationURL:`https://github.com/equitherm/lovelace/blob/main/docs/cards/${i}.md`})}const hr=t=>`${t}-editor`;class cr extends TypeError{constructor(t,e){let i;const{message:r,explanation:n,...o}=t,{path:s}=t,a=0===s.length?r:`At path: ${s.join(".")} -- ${r}`;super(n??a),null!=n&&(this.cause=a),Object.assign(this,o),this.name=this.constructor.name,this.failures=()=>i??(i=[t,...e()])}}function ur(t){return"object"==typeof t&&null!=t}function dr(t){return ur(t)&&!Array.isArray(t)}function pr(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function mr(t,e,i,r){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:o}=e,{type:s}=i,{refinement:a,message:l=`Expected a value of type \`${s}\`${a?` with refinement \`${a}\``:""}, but received: \`${pr(r)}\``}=t;return{value:r,type:s,refinement:a,key:n[n.length-1],path:n,branch:o,...t,message:l}}function*_r(t,e,i,r){(function(t){return ur(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=mr(n,e,i,r);t&&(yield t)}}function*fr(t,e,i={}){const{path:r=[],branch:n=[t],coerce:o=!1,mask:s=!1}=i,a={path:r,branch:n,mask:s};o&&(t=e.coercer(t,a));let l="valid";for(const r of e.validator(t,a))r.explanation=i.message,l="not_valid",yield[r,void 0];for(let[h,c,u]of e.entries(t,a)){const e=fr(c,u,{path:void 0===h?r:[...r,h],branch:void 0===h?n:[...n,c],coerce:o,mask:s,message:i.message});for(const i of e)i[0]?(l=null!=i[0].refinement?"not_refined":"not_valid",yield[i[0],void 0]):o&&(c=i[1],void 0===h?t=c:t instanceof Map?t.set(h,c):t instanceof Set?t.add(c):ur(t)&&(void 0!==c||h in t)&&(t[h]=c))}if("not_valid"!==l)for(const r of e.refiner(t,a))r.explanation=i.message,l="not_refined",yield[r,void 0];"valid"===l&&(yield[void 0,t])}class gr{constructor(t){const{type:e,schema:i,validator:r,refiner:n,coercer:o=t=>t,entries:s=function*(){}}=t;this.type=e,this.schema=i,this.entries=s,this.coercer=o,this.validator=r?(t,e)=>_r(r(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>_r(n(t,e),e,this,t):()=>[]}assert(t,e){return yr(t,this,e)}create(t,e){return function(t,e,i){const r=br(t,e,{coerce:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}is(t){return function(t,e){const i=br(t,e);return!i[0]}(t,this)}mask(t,e){return function(t,e,i){const r=br(t,e,{coerce:!0,mask:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}validate(t,e={}){return br(t,this,e)}}function yr(t,e,i){const r=br(t,e,{message:i});if(r[0])throw r[0]}function br(t,e,i={}){const r=fr(t,e,i),n=function(t){const{done:e,value:i}=t.next();return e?void 0:i}(r);if(n[0]){const t=new cr(n[0],function*(){for(const t of r)t[0]&&(yield t[0])});return[t,void 0]}return[void 0,n[1]]}function vr(t,e){return new gr({type:t,schema:null,validator:e})}function wr(){return vr("any",()=>!0)}function Er(){return vr("boolean",t=>"boolean"==typeof t)}function xr(){return vr("number",t=>"number"==typeof t&&!isNaN(t)||`Expected a number, but received: ${pr(t)}`)}function $r(t){return new gr({...t,validator:(e,i)=>void 0===e||t.validator(e,i),refiner:(e,i)=>void 0===e||t.refiner(e,i)})}function Sr(){return vr("string",t=>"string"==typeof t||`Expected a string, but received: ${pr(t)}`)}function Tr(t){const e=Object.keys(t);return new gr({type:"type",schema:t,*entries(i){if(ur(i))for(const r of e)yield[r,i[r],t[r]]},validator:t=>dr(t)||`Expected an object, but received: ${pr(t)}`,coercer:t=>dr(t)?{...t}:t})}const Cr=Tr({type:Sr(),climate_entity:Sr(),outdoor_entity:Sr(),flow_entity:Sr(),curve_output_entity:$r(Sr()),pid_output_entity:$r(Sr()),rate_limiting_entity:$r(Sr()),pid_active_entity:$r(Sr()),pid_correction_entity:$r(Sr()),wws_entity:$r(Sr()),hc_entity:$r(Sr()),shift_entity:$r(Sr()),n_entity:$r(Sr()),show_last_updated:$r(Er()),show_params_footer:$r(Er()),tunable:$r(Er()),recalculate_service:$r(Sr()),name:$r(wr())});function Ar(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,yr(e,Cr),e}const Hr="equitherm",Nr=`${Hr}-status-card`,Pr=hr(Nr),Dr=["climate"],kr=["sensor"];function Mr(t,e,i,r){const n=t=>t.find(t=>r.includes(It(t)));return n(e)??n(i)??n(Object.keys(t.states))}function Br(t,e=[],i=[]){return Mr(t,e,i,Dr)}function Ir(t,e=[],i=[]){return Mr(t,e,i,["weather"])}function Or(t){const e=t.states;return Object.keys(e).filter(t=>{const i=e[t];return kr.includes(It(t))&&"temperature"===i?.attributes?.device_class})}function Rr(t){const e=Or(t);return e.find(t=>t.includes("outdoor")||t.includes("outside")||t.includes("exterior"))??e[0]}function Lr(t){const e=Or(t);return e.find(t=>t.includes("flow")||t.includes("supply")||t.includes("forward"))??e[0]}function Fr(t){return Or(t).find(t=>t.includes("curve_output"))??""}let Ur=class extends lt{constructor(){super(...arguments),this.label="",this.active=!1}static get styles(){return a`
      :host {
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}};t([pt({attribute:!1})],Xr.prototype,"hass",void 0),t([pt({attribute:!1})],Xr.prototype,"config",void 0),t([pt({type:Boolean})],Xr.prototype,"open",void 0),t([mt()],Xr.prototype,"_proposedHc",void 0),t([mt()],Xr.prototype,"_proposedShift",void 0),t([mt()],Xr.prototype,"_applying",void 0),t([mt()],Xr.prototype,"_applySuccess",void 0),t([mt()],Xr.prototype,"_chartConfig",void 0),Xr=t([ct("eq-tuning-dialog")],Xr);const Kr={n:1.25,min_flow:20,max_flow:70,t_out_min:-30,t_out_max:30},Yr={n:$r(xr()),min_flow:$r(xr()),max_flow:$r(xr()),t_out_min:$r(xr()),t_out_max:$r(xr())},Zr={min_flow_entity:$r(Sr()),max_flow_entity:$r(Sr())};function Jr(t){const e=t.hc_entity,i=t.shift_entity;if(e&&i)return{climate_entity:t.climate_entity,outdoor_entity:t.outdoor_entity,flow_entity:t.flow_entity,hc_entity:e,shift_entity:i,n_entity:t.n_entity,min_flow_entity:t.min_flow_entity,max_flow_entity:t.max_flow_entity,recalculate_service:t.recalculate_service,curve_from_entities:t.curve_from_entities??!!t.n_entity,n:t.n??Kr.n,min_flow:t.min_flow??Kr.min_flow,max_flow:t.max_flow??Kr.max_flow,t_out_min:t.t_out_min??Kr.t_out_min,t_out_max:t.t_out_max??Kr.t_out_max}}lr({type:Nr,name:"Equitherm Status",description:"Compact heating status tile with temperature displays"});let Qr=class extends tr{getGridOptions(){return{columns:12,rows:this._config.show_last_updated?4:3,min_rows:3}}static getStubConfig(t,e,i){return{type:"custom:equitherm-status-card",climate_entity:Br(t,e,i)??"",outdoor_entity:Rr(t)??"",flow_entity:Lr(t)??""}}static async getConfigElement(){return await Promise.resolve().then(function(){return fn}),document.createElement(Pr)}setConfig(t){this._config=Ar(t),this._dialogConfig=Jr(this._config)}_lastUpdatedEntity(){return this._config.flow_entity}get _hasParamsFooter(){const t=this._config;return!!(t.hc_entity||t.shift_entity||t.n_entity||t.pid_correction_entity)}static get styles(){return[super.styles,nr,Qi,sr,ar,or,a`
        ha-card {
          height: 100%;
          display: flex;
          flex-direction: column;
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};Qr=t([ct(Nr)],Qr);const tn=`${Hr}-curve-card`,en=hr(tn),rn=Tr({type:Sr(),climate_entity:Sr(),outdoor_entity:Sr(),curve_output_entity:$r(Sr()),pid_output_entity:$r(Sr()),flow_entity:Sr(),rate_limiting_entity:$r(Sr()),pid_active_entity:$r(Sr()),wws_entity:$r(Sr()),show_last_updated:$r(Er()),show_kpi_footer:$r(Er()),show_params_footer:$r(Er()),name:$r(wr()),curve_from_entities:$r(wr()),hc_entity:$r(Sr()),n_entity:$r(Sr()),shift_entity:$r(Sr()),tunable:$r(Er()),recalculate_service:$r(Sr()),...Zr,hc:$r(xr()),shift:$r(xr()),...Yr,gradient_warm_color:$r(Sr()),gradient_cool_color:$r(Sr())}),nn={hc:.9,shift:0,...Kr};function on(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,yr(e,rn),{...nn,...e}}let sn=class extends lt{constructor(){super(...arguments),this._active=!1}connectedCallback(){super.connectedCallback();const t=this.getRootNode();this._hostEl=t.host,this._hostEl&&(this._active=this._hostEl.hasAttribute("manual-override"),this._observer=new MutationObserver(()=>{this._active=this._hostEl.hasAttribute("manual-override")}),this._observer.observe(this._hostEl,{attributes:!0,attributeFilter:["manual-override"]}))}disconnectedCallback(){this._observer?.disconnect(),super.disconnectedCallback()}static get styles(){return a`
      :host {
        position: absolute;
        inset: 0;
        display: flex;
    ...
    `}render(){if(!this._active)return V;const t=Ui(this.getRootNode()?.host?.hass);return z`
      <div class="chip">
        <ha-icon icon="mdi:hand-back-right"></ha-icon>
        ${t("common.manual_override")}
      </div>
    `}};t([mt()],sn.prototype,"_active",void 0),sn=t([ct("eq-manual-overlay")],sn),lr({type:tn,name:"Equitherm Curve",description:"Heating curve visualization with current operating point"});let an=class extends ir{willUpdate(t){if(super.willUpdate(t),t.has("_config"))return this._applyGradientColors(),void this._updateChartConfig();if(t.has("hass")&&this.hass){const e=t.get("hass");e&&!this._relevantStateChanged(e)||this._updateChartConfig()}}_relevantStateChanged(t){return[this._config.outdoor_entity,this._config.flow_entity,this._config.climate_entity,this._config.rate_limiting_entity,this._config.pid_output_entity,this._config.curve_output_entity,this._config.pid_active_entity,...this._config.curve_from_entities||this._config.tunable?[this._config.hc_entity,this._config.shift_entity,this._config.n_entity,this._config.min_flow_entity,this._config.max_flow_entity]:[]].filter(Boolean).some(e=>this.hass.states[e]?.state!==t.states[e]?.state)}_applyGradientColors(){this._setColorVar("--curve-gradient-start",this._config.gradient_warm_color),this._setColorVar("--curve-gradient-end",this._config.gradient_cool_color)}_setColorVar(t,e){if(!e)return void this.style.removeProperty(t);const i=this._resolveToRgbTriple(e);i&&this.style.setProperty(t,i)}_resolveToRgbTriple(t){if(t.startsWith("#"))return this._hexToRgbTriple(t);const e=getComputedStyle(document.body).getPropertyValue(`--${t}-color`).trim();return e?this._hexToRgbTriple(e):void 0}_hexToRgbTriple(t){const e=t.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i);if(e)return`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`}static getStubConfig(t,e,i){return{type:"custom:equitherm-curve-card",climate_entity:Br(t,e,i)??"",outdoor_entity:Rr(t)??"",curve_output_entity:Fr(t),flow_entity:Lr(t)??"",hc:1.2,n:1.25,shift:0,min_flow:25,max_flow:70,t_out_min:-20,t_out_max:20}}static async getConfigElement(){return await Promise.resolve().then(function(){return yn}),document.createElement(en)}setConfig(t){this._config=on(t),this._dialogConfig=Jr(this._config)}_lastUpdatedEntity(){return this._config.flow_entity}get _tTarget(){return this._climate?.attributes.temperature??21}get _tOutdoor(){const t=this._entityState(this._config.outdoor_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:this._fromDisplayTemp(e)}get _flowTemp(){const t=this._entityState(this._config.flow_entity);if(t){const e=parseFloat(t.state);if(!isNaN(e))return this._fromDisplayTemp(e)}return this._config.min_flow}get _currentN(){return this._config.curve_from_entities?this._resolveEntityNumber(this._config.n_entity,this._config.n):this._config.n}_renderParamsFooterContent(){return this._config.curve_from_entities?this._renderTunableParamsFooter({hc:this._config.hc_entity?{entity:this._config.hc_entity,fallback:this._config.hc,onClick:this._config.tunable?void 0:()=>{this._showTuningDialog=!0}}:void 0,n:this._config.n_entity?{entity:this._config.n_entity,fallback:this._config.n}:void 0,shift:this._config.shift_entity?{entity:this._config.shift_entity,fallback:this._config.shift,onClick:this._config.tunable?void 0:()=>{this._showTuningDialog=!0}}:void 0},()=>{this._showTuningDialog=!0}):V}_buildEChartOptions(){return this._buildSingleCurveOptions()}_buildSingleCurveOptions(){const t=Ui(this.hass),e=this._config,i={tTarget:this._tTarget,hc:e.curve_from_entities?this._resolveEntityNumber(e.hc_entity,e.hc):e.hc,n:e.curve_from_entities?this._resolveEntityNumber(e.n_entity,e.n):e.n,shift:e.curve_from_entities?this._resolveEntityTemp(e.shift_entity,e.shift):e.shift,minFlow:e.curve_from_entities?this._resolveEntityTemp(e.min_flow_entity,e.min_flow):e.min_flow,maxFlow:e.curve_from_entities?this._resolveEntityTemp(e.max_flow_entity,e.max_flow):e.max_flow},r=getComputedStyle(this),n=r.getPropertyValue("--curve-gradient-start").trim(),o=r.getPropertyValue("--curve-gradient-end").trim(),s=n?`rgb(${n})`:Xi(this,"heating"),a=o?`rgb(${o})`:Xi(this,"cooling"),l=`rgba(${r.getPropertyValue("--rgb-warning").trim()||"255, 167, 38"}, 0.08)`,h=e.t_out_max,c=Gr(i,e.t_out_min,h).map(t=>({x:this._toDisplayTemp(t.x),y:this._toDisplayTemp(t.y)})),u=this._tOutdoor,d=[],p=Ki(this._config,t=>this._entityState(t)),m=Yi(this._config);if(null!==u&&!this._isWWSD){const t=this._toDisplayTemp(u),e=zr(i,u),r=this._toDisplayTemp(e);if(p){const e=m&&this._entityState(m)?parseFloat(this._entityState(m).state):r;if(this._config.pid_output_entity&&this._config.curve_output_entity){const e=this._entityState(this._config.curve_output_entity),i=e?parseFloat(e.state):r;d.push({value:[t,i],symbolSize:8,itemStyle:{color:"transparent",borderColor:s,borderWidth:1.5}})}d.push({value:[t,e],symbolSize:10,itemStyle:{color:s,borderColor:"#ffffff",borderWidth:2}}),d.push({value:[t,this._toDisplayTemp(this._flowTemp)],symbolSize:8,itemStyle:{color:"transparent",borderColor:s,borderWidth:2}})}else d.push({value:[t,r],symbolSize:9,itemStyle:{color:s,borderColor:"#ffffff",borderWidth:2}})}const _=c.reduce((t,e)=>Math.min(t,e.y),1/0),f=c.reduce((t,e)=>Math.max(t,e.y),-1/0),g=jr(_,f),y=Math.min(this._toDisplayTemp(0),g.min),b=g.max,v=Vr(y,b),w=c.filter((t,e)=>e%50==0).map(t=>[t.x,t.y]);return{options:{animation:!1,xAxis:{type:"value",min:this._toDisplayTemp(e.t_out_min),max:this._toDisplayTemp(e.t_out_max),inverse:!0,axisLabel:{fontSize:10,formatter:t=>`${parseFloat(t.toFixed(1))}`},axisTick:{show:!1},axisLine:{show:!1}},yAxis:{type:"value",axisLabel:{fontSize:10,formatter:t=>`${parseFloat(t.toFixed(v))}`},min:y,max:b},grid:{top:5,right:5,bottom:20,left:30},tooltip:{trigger:"axis",position:Wr,backgroundColor:"rgba(var(--rgb-card-background-color, 255, 255, 255), 0.95)",borderColor:"var(--divider-color, rgba(0,0,0,0.12))",borderWidth:1,padding:[8,12],textStyle:{color:"var(--primary-text-color)",fontSize:12},formatter:e=>{const i=(Array.isArray(e)?e:[]).find(e=>e.seriesName===t("curve_card.flow_temp"));if(!i)return V;const r=i.value[0],n=i.value[1],o=this.hass?.config?.unit_system?.temperature??"°C",a=t=>`${parseFloat(t.toFixed(1))} ${o}`;return z`
    ...
    `}static get styles(){return[super.styles,nr,Qi,sr,ar,or,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};an=t([ct(tn)],an);const ln=`${Hr}-forecast-card`,hn=hr(ln),cn=Tr({type:Sr(),weather_entity:Sr(),climate_entity:Sr(),flow_entity:Sr(),hours:$r(xr()),name:$r(wr()),curve_from_entities:$r(wr()),hc_entity:$r(Sr()),n_entity:$r(Sr()),shift_entity:$r(Sr()),...Zr,outdoor_entity:$r(Sr()),pid_active_entity:$r(Sr()),wws_entity:$r(Sr()),show_last_updated:$r(Er()),show_kpi_footer:$r(Er()),show_params_footer:$r(Er()),tunable:$r(Er()),recalculate_service:$r(Sr()),hc:$r(xr()),...Yr,shift:$r(xr())}),un={hours:24,hc:.9,shift:0,...Kr};function dn(t){return yr(t,cn),{...un,...t}}lr({type:ln,name:"Equitherm Forecast",description:"Heating forecast based on weather predictions"});let pn=class extends ir{constructor(){super(...arguments),this._forecastPoints=[]}updated(t){super.updated(t),(t.has("_config")||!this._unsub&&t.has("hass"))&&this._subscribeForecast(),t.has("_forecastPoints")&&this._updateChartConfig()}static getStubConfig(t,e,i){return{type:"custom:equitherm-forecast-card",weather_entity:Ir(t,e,i)??"",climate_entity:Br(t,e,i)??"",flow_entity:Lr(t)??"",hours:24,hc:1.2,n:1.25,shift:0,min_flow:25,max_flow:70}}static async getConfigElement(){return await Promise.resolve().then(function(){return vn}),document.createElement(hn)}setConfig(t){this._config=dn(t),this._dialogConfig=Jr(this._config)}_lastUpdatedEntity(){return this._config.weather_entity}get _tTarget(){return this._climate?.attributes.temperature??21}get _flowTemp(){const t=this._entityState(this._config.flow_entity);if(t){const e=parseFloat(t.state);if(!isNaN(e))return this._fromDisplayTemp(e)}return this._config.min_flow}get _outdoorTemp(){if(this._config.outdoor_entity){const t=this._entityState(this._config.outdoor_entity);if(t){const e=parseFloat(t.state);if(!isNaN(e))return this._fromDisplayTemp(e)}}const t=this._entityState(this._config.weather_entity);if(t){const e=parseFloat(t.attributes.temperature);if(!isNaN(e))return this._fromDisplayTemp(e)}return NaN}get _outdoorTempFormatted(){const t=this._outdoorTemp;return isNaN(t)?"—":this._formatCalcTemp(t)}get _isWWSD(){if(this._config?.wws_entity){const t=this._entityState(this._config.wws_entity);return"on"===t?.state}const t=this._climate?.attributes.temperature;return null!=t&&(!isNaN(this._outdoorTemp)&&this._outdoorTemp>=t)}_wwsdDescription(){const t=Ui(this.hass),e=this._climate?.attributes.temperature;return isNaN(this._outdoorTemp)||null==e?t("common.wwsd_label"):`${t("common.outdoor")} ${this._formatCalcTemp(this._outdoorTemp)} ≥ ${this._formatCalcTemp(e)}`}get _curveParams(){const t=this._config;return{tTarget:this._tTarget,hc:t.curve_from_entities?this._resolveEntityNumber(t.hc_entity,t.hc):t.hc,n:t.curve_from_entities?this._resolveEntityNumber(t.n_entity,t.n):t.n,shift:t.curve_from_entities?this._resolveEntityNumber(t.shift_entity,t.shift):t.shift,minFlow:t.curve_from_entities?this._resolveEntityNumber(t.min_flow_entity,t.min_flow):t.min_flow,maxFlow:t.curve_from_entities?this._resolveEntityNumber(t.max_flow_entity,t.max_flow):t.max_flow}}_processForecast(t){const e=t.map(t=>({datetime:t.datetime,temperature:this._fromDisplayTemp(t.temperature)}));this._forecastPoints=function(t,e,i){return t.slice(0,i).map(t=>({datetime:t.datetime,hour:new Date(t.datetime).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),tOutdoor:t.temperature,tFlow:qr({...e,tOutdoor:t.temperature})}))}(e,this._curveParams,this._config.hours)}_unsubscribeForecast(){this._unsub&&(this._unsub(),this._unsub=void 0)}async _subscribeForecast(){if(this._unsubscribeForecast(),this.isConnected&&this.hass&&this._config?.weather_entity)try{const t=await this.hass.connection.subscribeMessage(t=>{t.forecast&&this._processForecast(t.forecast)},{type:"weather/subscribe_forecast",forecast_type:"hourly",entity_id:this._config.weather_entity});this._unsub?t():this._unsub=t}catch(t){console.warn("Failed to subscribe to weather forecast:",t)}}_buildEChartOptions(){const t=this._forecastPoints,e=Ui(this.hass),i=Xi(this,"heating"),r=Xi(this,"cooling"),n=function(t){if(0!==t.length)return t.reduce((t,e)=>e.tFlow>(t?.tFlow??0)?e:t,t[0])}(t),o=n?[{value:[new Date(n.datetime).getTime(),this._toDisplayTemp(n.tFlow)],symbolSize:6,itemStyle:{color:i,borderColor:"#fff",borderWidth:2},label:{show:!0,formatter:`${e("forecast_card.peak")}: ${this._toDisplayTemp(n.tFlow).toFixed(1)}${this.hass?.config?.unit_system?.temperature??"°C"}`,color:"#fff",backgroundColor:i,fontSize:11,fontWeight:600,padding:[2,6],borderRadius:3,position:"top"}}]:[],s=jr(this._curveParams.minFlow??20,this._curveParams.maxFlow??70),a=Math.min(this._toDisplayTemp(0),this._toDisplayTemp(s.min)),l=this._toDisplayTemp(s.max),h=Vr(a,l);return{options:{animation:!1,xAxis:{type:"time",axisLabel:{fontSize:10,hideOverlap:!0,formatter:t=>this._formatChartTime(t)},axisTick:{show:!1},axisLine:{show:!1}},yAxis:[{type:"value",axisLabel:{fontSize:10,formatter:t=>`${parseFloat(t.toFixed(h))}`},min:a,max:l},{type:"value",axisLabel:{fontSize:10}}],grid:{top:15,right:15,bottom:25,left:35},tooltip:{trigger:"axis",position:Wr,backgroundColor:"rgba(var(--rgb-card-background-color, 255, 255, 255), 0.95)",borderColor:"var(--divider-color, rgba(0,0,0,0.12))",borderWidth:1,padding:[8,12],textStyle:{color:"var(--primary-text-color)",fontSize:12},formatter:t=>{const e=this._formatChartTime(t[0].value[0]),i=this.hass?.config?.unit_system?.temperature??"°C",r=t.filter(t=>"peak"!==t.seriesName);return z`
    ...
    `}_onChartDisconnecting(){this._unsubscribeForecast()}_onChartReconnected(){this._subscribeForecast()}static get styles(){return[super.styles,nr,Qi,sr,or,ar,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};t([mt()],pn.prototype,"_forecastPoints",void 0),pn=t([ct(ln)],pn),console.info("%c EQUITHERM-CARDS %c 1.6.1 ","color: white; background: #f97316; font-weight: bold;","color: #f97316; background: white; font-weight: bold;");const mn={entity:function(t,e={}){return{name:t,required:e.required??!0,selector:{entity:{filter:{domain:e.domain,device_class:e.device_class}}}}},number:function(t,e,i,r=1,n={}){return{name:t,required:n.required??!1,...void 0!==n.default&&{default:n.default},selector:{number:{min:e,max:i,step:r,mode:n.mode??"box",unit_of_measurement:n.unit_of_measurement}}}},text:function(t,e=!1){return{name:t,required:e,selector:{text:{}}}},entityName:function(t,e){return{name:t,selector:{entity_name:{}},context:e}},grid:function(t){return{type:"grid",name:"",schema:t}},expandable:function(t,e,i){return{type:"expandable",flatten:!0,title:t,icon:e,name:"",schema:i}}};let _n=class extends rr{constructor(){super(...arguments),this._schemaMemo=Qt(t=>{const e=Ui(this.hass);return[mn.entity("climate_entity",{domain:"climate"}),mn.entityName("name",{entity:"climate_entity"}),mn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),mn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...t?[mn.expandable(e("editor.tuning"),"mdi:tune-variant",[mn.entity("hc_entity",{domain:["number","input_number"]}),mn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],mn.expandable(e("editor.optional"),"mdi:connection",[mn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),mn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),mn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),mn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),mn.entity("wws_entity",{domain:["binary_sensor"],required:!1}),mn.entity("pid_correction_entity",{domain:["sensor","input_number"],device_class:"temperature",required:!1})]),mn.expandable(e("editor.curve_parameters"),"mdi:chart-bell-curve-cumulative",[mn.entity("hc_entity",{domain:["number","input_number"],required:!1}),mn.entity("shift_entity",{domain:["number","input_number"],required:!1}),mn.entity("n_entity",{domain:["number","input_number"],required:!1})])]})}setConfig(t){this._config={...t}}_validate(t){Ar(t)}_getSchema(){return this._schemaMemo(!!this._config.tunable)}};_n=t([ct(Pr)],_n);var fn=Object.freeze({__proto__:null,get StatusCardEditor(){return _n}});let gn=class extends rr{constructor(){super(...arguments),this._schemaMemo=Qt((t,e,i)=>{const r=this.hass?.config?.unit_system?.temperature??"°C",n=t=>Math.round(10*xt(t,i))/10,o=t=>Math.round(10*St(t,i))/10,s=Ui(this.hass);return[mn.entity("climate_entity",{domain:"climate"}),mn.entityName("name",{entity:"climate_entity"}),mn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),mn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),mn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"tunable",selector:{boolean:{}},default:!1},{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},...e?[mn.expandable(s("editor.tuning"),"mdi:tune-variant",[mn.entity("hc_entity",{domain:["number","input_number"]}),mn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],mn.expandable(s("editor.optional"),"mdi:connection",[mn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),mn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),mn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),mn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),mn.expandable(s("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[mn.entity("hc_entity",{domain:"number"}),mn.entity("n_entity",{domain:"number"}),mn.entity("shift_entity",{domain:"number"}),mn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),mn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[mn.grid([mn.number("hc",.5,3,.1,{default:.9}),mn.number("n",1,2,.05,{default:1.25})]),mn.number("shift",o(-15),o(15),1,{unit_of_measurement:r,default:o(0)}),mn.grid([mn.number("min_flow",n(15),n(35),1,{unit_of_measurement:r,default:n(20)}),mn.number("max_flow",n(50),n(90),1,{unit_of_measurement:r,default:n(70)})])]]),mn.expandable(s("editor.display_range"),"mdi:arrow-expand-horizontal",[mn.grid([mn.number("t_out_min",n(-30),n(5),1,{unit_of_measurement:r,default:n(-30)}),mn.number("t_out_max",n(0),n(30),1,{unit_of_measurement:r,default:n(30)})])]),mn.expandable(s("editor.appearance"),"mdi:palette-outline",[{name:"gradient_warm_color",selector:{ui_color:{}}},{name:"gradient_cool_color",selector:{ui_color:{}}}])]})}setConfig(t){this._config={...t}}_validate(t){on(t)}_transformConfig(t){if(!Et(this.hass))return t;const e={...t};null!=e.shift&&(e.shift=Tt(e.shift,!0));for(const t of["min_flow","max_flow","t_out_min","t_out_max"])null!=e[t]&&(e[t]=$t(e[t],!0));return e}_getDisplayConfig(){if(!Et(this.hass))return this._config;const t={...this._config};null!=t.shift&&(t.shift=Math.round(10*St(t.shift,!0))/10);for(const e of["min_flow","max_flow","t_out_min","t_out_max"])null!=t[e]&&(t[e]=Math.round(10*xt(t[e],!0))/10);return t}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable,Et(this.hass))}};gn=t([ct(en)],gn);var yn=Object.freeze({__proto__:null,get EquithermCurveCardEditor(){return gn}});let bn=class extends rr{constructor(){super(...arguments),this._schemaMemo=Qt((t,e)=>{const i=Ui(this.hass);return[mn.entity("weather_entity",{domain:"weather"}),mn.entity("climate_entity",{domain:"climate"}),mn.entityName("name",{entity:"climate_entity"}),mn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...e?[mn.expandable(i("editor.tuning"),"mdi:tune-variant",[mn.entity("hc_entity",{domain:["number","input_number"]}),mn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],mn.expandable(i("editor.optional"),"mdi:connection",[mn.entity("outdoor_entity",{domain:["sensor","number","input_number"],device_class:"temperature",required:!1}),mn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),mn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),mn.expandable(i("editor.forecast_settings"),"mdi:clock-outline",[mn.number("hours",1,48,1,{unit_of_measurement:"h",default:24})]),mn.expandable(i("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[mn.entity("hc_entity",{domain:"number"}),mn.entity("n_entity",{domain:"number"}),mn.entity("shift_entity",{domain:"number"}),mn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),mn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[mn.grid([mn.number("hc",.5,3,.1,{default:.9}),mn.number("n",1,2,.05,{default:1.25})]),mn.number("shift",-15,15,1,{unit_of_measurement:"°C",default:0}),mn.grid([mn.number("min_flow",15,35,1,{unit_of_measurement:"°C",default:20}),mn.number("max_flow",50,90,1,{unit_of_measurement:"°C",default:70})])]])]})}setConfig(t){this._config={...t}}_validate(t){dn(t)}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable)}};bn=t([ct(hn)],bn);var vn=Object.freeze({__proto__:null,get EquithermForecastCardEditor(){return bn}});

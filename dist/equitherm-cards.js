...
`;class Wi extends Mi{constructor(){super(...arguments),this._showTuningDialog=!1,this._openTuningDialog=()=>{this._showTuningDialog=!0},this._onDeltaParamChanged=t=>{const e=t.target.dataset.entityId;if(!e||!this.hass)return;const i=this._fromDisplayDelta(t.detail.value);this.hass.callService(It(e),"set_value",{entity_id:e,value:i})},this._onParamChanged=t=>{const e=t.target.dataset.entityId;e&&this.hass&&this.hass.callService(It(e),"set_value",{entity_id:e,value:t.detail.value})}}get _climate(){return this._entityState(this._config.climate_entity)}get _isManualPreset(){return"Manual"===this._climate?.attributes.preset_mode}updated(t){super.updated(t),t.has("hass")&&this.hass&&this.toggleAttribute("manual-override",this._isManualPreset)}get _roomTemp(){const t=this._climate?.attributes.current_temperature;return this._formatCalcTemp(t)}get _outdoorTempFormatted(){return this._formatEntityTemp(this._config.outdoor_entity)}get _flowTempFormatted(){return this._formatEntityTemp(this._config.flow_entity)}get _curveOutputTempFormatted(){const t=Gi(this._config);return t?this._formatEntityTemp(t):""}get _isWWSD(){if(!this._config?.climate_entity)return!1;const t=this._climate?.attributes.temperature;if(null==t)return!1;if(!this._config.outdoor_entity)return!1;const e=this._entityState(this._config.outdoor_entity);if(!e)return!1;const i=parseFloat(e.state),r=isNaN(i)?NaN:this._fromDisplayTemp(i);return!isNaN(r)&&r>=t}_wwsdDescription(){const t=Bi(this.hass),e=this._climate?.attributes.temperature,i=this._config.outdoor_entity,r=i?this._entityState(i):void 0,n=r?this._fromDisplayTemp(parseFloat(r.state)):NaN;return isNaN(n)||null==e?t("common.wwsd_label"):`${t("common.outdoor")} ${this._formatEntityTemp(i)} ≥ ${this._formatCalcTemp(e)}`}_renderNotFound(t,e){if(!t||this._entityExists(t))return V;const i=Bi(this.hass);return z`
      <div class="not-found">
  ...
  `,t([pt({attribute:!1})],Ki.prototype,"hass",void 0),t([mt()],Ki.prototype,"_config",void 0),t([mt()],Ki.prototype,"_error",void 0);const Yi=a`
  :host {
...
`;function tr(t){const e=window;e.customCards=e.customCards||[];const i=t.type.replace("-card","").replace("equitherm-","");e.customCards.push({...t,preview:!0,documentationURL:`https://github.com/equitherm/lovelace/blob/main/docs/cards/${i}.md`})}const er=t=>`${t}-editor`;class ir extends TypeError{constructor(t,e){let i;const{message:r,explanation:n,...o}=t,{path:s}=t,a=0===s.length?r:`At path: ${s.join(".")} -- ${r}`;super(n??a),null!=n&&(this.cause=a),Object.assign(this,o),this.name=this.constructor.name,this.failures=()=>i??(i=[t,...e()])}}function rr(t){return"object"==typeof t&&null!=t}function nr(t){return rr(t)&&!Array.isArray(t)}function or(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function sr(t,e,i,r){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:o}=e,{type:s}=i,{refinement:a,message:l=`Expected a value of type \`${s}\`${a?` with refinement \`${a}\``:""}, but received: \`${or(r)}\``}=t;return{value:r,type:s,refinement:a,key:n[n.length-1],path:n,branch:o,...t,message:l}}function*ar(t,e,i,r){(function(t){return rr(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=sr(n,e,i,r);t&&(yield t)}}function*lr(t,e,i={}){const{path:r=[],branch:n=[t],coerce:o=!1,mask:s=!1}=i,a={path:r,branch:n,mask:s};o&&(t=e.coercer(t,a));let l="valid";for(const r of e.validator(t,a))r.explanation=i.message,l="not_valid",yield[r,void 0];for(let[h,c,u]of e.entries(t,a)){const e=lr(c,u,{path:void 0===h?r:[...r,h],branch:void 0===h?n:[...n,c],coerce:o,mask:s,message:i.message});for(const i of e)i[0]?(l=null!=i[0].refinement?"not_refined":"not_valid",yield[i[0],void 0]):o&&(c=i[1],void 0===h?t=c:t instanceof Map?t.set(h,c):t instanceof Set?t.add(c):rr(t)&&(void 0!==c||h in t)&&(t[h]=c))}if("not_valid"!==l)for(const r of e.refiner(t,a))r.explanation=i.message,l="not_refined",yield[r,void 0];"valid"===l&&(yield[void 0,t])}class hr{constructor(t){const{type:e,schema:i,validator:r,refiner:n,coercer:o=t=>t,entries:s=function*(){}}=t;this.type=e,this.schema=i,this.entries=s,this.coercer=o,this.validator=r?(t,e)=>ar(r(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>ar(n(t,e),e,this,t):()=>[]}assert(t,e){return cr(t,this,e)}create(t,e){return function(t,e,i){const r=ur(t,e,{coerce:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}is(t){return function(t,e){const i=ur(t,e);return!i[0]}(t,this)}mask(t,e){return function(t,e,i){const r=ur(t,e,{coerce:!0,mask:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}validate(t,e={}){return ur(t,this,e)}}function cr(t,e,i){const r=ur(t,e,{message:i});if(r[0])throw r[0]}function ur(t,e,i={}){const r=lr(t,e,i),n=function(t){const{done:e,value:i}=t.next();return e?void 0:i}(r);if(n[0]){const t=new ir(n[0],function*(){for(const t of r)t[0]&&(yield t[0])});return[t,void 0]}return[void 0,n[1]]}function dr(t,e){return new hr({type:t,schema:null,validator:e})}function pr(){return dr("any",()=>!0)}function mr(){return dr("boolean",t=>"boolean"==typeof t)}function _r(){return dr("number",t=>"number"==typeof t&&!isNaN(t)||`Expected a number, but received: ${or(t)}`)}function fr(t){return new hr({...t,validator:(e,i)=>void 0===e||t.validator(e,i),refiner:(e,i)=>void 0===e||t.refiner(e,i)})}function gr(){return dr("string",t=>"string"==typeof t||`Expected a string, but received: ${or(t)}`)}function yr(t){const e=Object.keys(t);return new hr({type:"type",schema:t,*entries(i){if(rr(i))for(const r of e)yield[r,i[r],t[r]]},validator:t=>nr(t)||`Expected an object, but received: ${or(t)}`,coercer:t=>nr(t)?{...t}:t})}const br=yr({type:gr(),climate_entity:gr(),outdoor_entity:gr(),flow_entity:gr(),curve_output_entity:fr(gr()),pid_output_entity:fr(gr()),rate_limiting_entity:fr(gr()),pid_active_entity:fr(gr()),pid_correction_entity:fr(gr()),hc_entity:fr(gr()),shift_entity:fr(gr()),n_entity:fr(gr()),show_last_updated:fr(mr()),show_params_footer:fr(mr()),tunable:fr(mr()),recalculate_service:fr(gr()),name:fr(pr())});function vr(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,cr(e,br),e}const wr="equitherm",Er=`${wr}-status-card`,xr=er(Er),$r=["climate"],Sr=["sensor"];function Tr(t){return Object.keys(t.states).find(t=>$r.includes(It(t)))}function Cr(t){return Object.keys(t.states).find(t=>"weather"===It(t))}function Ar(t){const e=t.states;return Object.keys(e).filter(t=>{const i=e[t];return Sr.includes(It(t))&&"temperature"===i?.attributes?.device_class})}function Hr(t){const e=Ar(t);return e.find(t=>t.includes("outdoor")||t.includes("outside")||t.includes("exterior"))??e[0]}function Nr(t){const e=Ar(t);return e.find(t=>t.includes("flow")||t.includes("supply")||t.includes("forward"))??e[0]}function Pr(t){return Ar(t).find(t=>t.includes("curve_output"))??""}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dr=Nt(class extends Pt{constructor(t){if(super(t),t.type!==Ht||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const r=!!e[t];r===this.st.has(t)||this.nt?.has(t)||(r?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return j}});let kr=class extends lt{constructor(){super(...arguments),this.label="",this.active=!1}static get styles(){return a`
      :host {
    ...
    `}render(){const t=this.icon?z`<ha-icon class="icon" icon=${this.icon}></ha-icon>`:V;return z`
      <span class=${Dr({badge:!0,active:this.active})}>
        ${t}${this.label}
      </span>
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}};t([pt({attribute:!1})],Or.prototype,"hass",void 0),t([pt({attribute:!1})],Or.prototype,"config",void 0),t([pt({type:Boolean})],Or.prototype,"open",void 0),t([mt()],Or.prototype,"_proposedHc",void 0),t([mt()],Or.prototype,"_proposedShift",void 0),t([mt()],Or.prototype,"_applying",void 0),t([mt()],Or.prototype,"_applySuccess",void 0),t([mt()],Or.prototype,"_chartConfig",void 0),Or=t([ct("eq-tuning-dialog")],Or);const Rr={n:1.25,min_flow:20,max_flow:70,t_out_min:-20,t_out_max:20},Lr={n:fr(_r()),min_flow:fr(_r()),max_flow:fr(_r()),t_out_min:fr(_r()),t_out_max:fr(_r())},Fr={min_flow_entity:fr(gr()),max_flow_entity:fr(gr())};function Ur(t){const e=t.hc_entity,i=t.shift_entity;if(e&&i)return{climate_entity:t.climate_entity,outdoor_entity:t.outdoor_entity,flow_entity:t.flow_entity,hc_entity:e,shift_entity:i,n_entity:t.n_entity,min_flow_entity:t.min_flow_entity,max_flow_entity:t.max_flow_entity,recalculate_service:t.recalculate_service,curve_from_entities:t.curve_from_entities??!!t.n_entity,n:t.n??Rr.n,min_flow:t.min_flow??Rr.min_flow,max_flow:t.max_flow??Rr.max_flow,t_out_min:t.t_out_min??Rr.t_out_min,t_out_max:t.t_out_max??Rr.t_out_max}}tr({type:Er,name:"Equitherm Status",description:"Compact heating status tile with temperature displays"});let qr=class extends Wi{getGridOptions(){return{columns:12,rows:this._config.show_last_updated?4:3,min_rows:3}}static async getStubConfig(t){return{type:"custom:equitherm-status-card",climate_entity:Tr(t),outdoor_entity:Hr(t),flow_entity:Nr(t)}}static async getConfigElement(){return await Promise.resolve().then(function(){return on}),document.createElement(xr)}setConfig(t){this._config=vr(t),this._dialogConfig=Ur(this._config)}_lastUpdatedEntity(){return this._config.flow_entity}get _hasParamsFooter(){const t=this._config;return!!(t.hc_entity||t.shift_entity||t.n_entity||t.pid_correction_entity)}static get styles(){return[super.styles,Yi,Vi,Ji,Qi,Zi,a`
        ha-card {
          height: 100%;
          display: flex;
          flex-direction: column;
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};qr=t([ct(Er)],qr);const Gr=`${wr}-curve-card`,zr=er(Gr),jr=yr({type:gr(),climate_entity:gr(),outdoor_entity:gr(),curve_output_entity:fr(gr()),pid_output_entity:fr(gr()),flow_entity:gr(),rate_limiting_entity:fr(gr()),pid_active_entity:fr(gr()),show_last_updated:fr(mr()),show_kpi_footer:fr(mr()),show_params_footer:fr(mr()),name:fr(pr()),curve_from_entities:fr(pr()),hc_entity:fr(gr()),n_entity:fr(gr()),shift_entity:fr(gr()),tunable:fr(mr()),recalculate_service:fr(gr()),...Fr,hc:fr(_r()),shift:fr(_r()),...Lr}),Vr={hc:.9,shift:0,...Rr};function Wr(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,cr(e,jr),{...Vr,...e}}let Xr=class extends lt{constructor(){super(...arguments),this._active=!1}connectedCallback(){super.connectedCallback();const t=this.getRootNode();this._hostEl=t.host,this._hostEl&&(this._active=this._hostEl.hasAttribute("manual-override"),this._observer=new MutationObserver(()=>{this._active=this._hostEl.hasAttribute("manual-override")}),this._observer.observe(this._hostEl,{attributes:!0,attributeFilter:["manual-override"]}))}disconnectedCallback(){this._observer?.disconnect(),super.disconnectedCallback()}static get styles(){return a`
      :host {
        position: absolute;
        inset: 0;
        display: flex;
    ...
    `}static get styles(){return[super.styles,Yi,Vi,Ji,Qi,Zi,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }
    ...
    `}_onChartDisconnecting(){this._unsubscribeForecast()}_onChartReconnected(){this._subscribeForecast()}static get styles(){return[super.styles,Yi,Vi,Ji,Zi,Qi,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }

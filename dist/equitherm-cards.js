...
`;class Wi extends Mi{constructor(){super(...arguments),this._showTuningDialog=!1,this._openTuningDialog=()=>{this._showTuningDialog=!0},this._onDeltaParamChanged=t=>{const e=t.target.dataset.entityId;if(!e||!this.hass)return;const i=this._fromDisplayDelta(t.detail.value);this.hass.callService(It(e),"set_value",{entity_id:e,value:i})},this._onParamChanged=t=>{const e=t.target.dataset.entityId;e&&this.hass&&this.hass.callService(It(e),"set_value",{entity_id:e,value:t.detail.value})}}get _climate(){return this._entityState(this._config.climate_entity)}get _isManualPreset(){return"Manual"===this._climate?.attributes.preset_mode}updated(t){super.updated(t),t.has("hass")&&this.hass&&this.toggleAttribute("manual-override",this._isManualPreset)}get _roomTemp(){const t=this._climate?.attributes.current_temperature;return this._formatCalcTemp(t)}get _outdoorTempFormatted(){return this._formatEntityTemp(this._config.outdoor_entity)}get _flowTempFormatted(){return this._formatEntityTemp(this._config.flow_entity)}get _curveOutputTempFormatted(){const t=Gi(this._config);return t?this._formatEntityTemp(t):""}get _isWWSD(){if(this._config?.wws_entity){const t=this._entityState(this._config.wws_entity);return"on"===t?.state}if(!this._config?.climate_entity)return!1;const t=this._climate?.attributes.temperature;if(null==t)return!1;if(!this._config.outdoor_entity)return!1;const e=this._entityState(this._config.outdoor_entity);if(!e)return!1;const i=parseFloat(e.state),r=isNaN(i)?NaN:this._fromDisplayTemp(i);return!isNaN(r)&&r>=t}_wwsdDescription(){const t=Bi(this.hass),e=this._climate?.attributes.temperature,i=this._config.outdoor_entity,r=i?this._entityState(i):void 0,n=r?this._fromDisplayTemp(parseFloat(r.state)):NaN;return isNaN(n)||null==e?t("common.wwsd_label"):`${t("common.outdoor")} ${this._formatEntityTemp(i)} ≥ ${this._formatCalcTemp(e)}`}_renderNotFound(t,e){if(!t||this._entityExists(t))return V;const i=Bi(this.hass);return z`
    ...
    `}_renderKpiFooter(t){if(!1===this._config.show_kpi_footer)return V;if(!this._config||!this.hass)return V;const e=Bi(this.hass),i=t?.outdoorClickEntity??this._config.outdoor_entity,r=!this._entityExists(i),n=!this._entityExists(this._config.flow_entity),o=!this._entityExists(this._config.climate_entity);return z`
    ...
    `}_getEntityRange(t,e,i){if(!t)return[e,i];return[this._entityAttr(t,"min")??e,this._entityAttr(t,"max")??i]}_getEntityStep(t,e){return t?this._entityAttr(t,"step")??e:e}_formatParamNum(t,e,i){return Qt(t,this.hass?.locale,{minimumFractionDigits:e,maximumFractionDigits:e,...i})}_renderDeltaParamItem(t,e,i,r,n){const o=this._resolveEntityNumber(e,i),[s,a]=this._getEntityRange(e,r[0],r[1]),l=this._getEntityStep(e,1),h=this._toDisplayDelta(o),c=this._toDisplayDelta(s),u=this._toDisplayDelta(a),d=this._toDisplayDelta(l),p=this.hass?.config?.unit_system?.temperature??"°C",m=this._formatParamNum(h,1,{signDisplay:"always"})+p,_=h>0?"positive":h<0?"negative":"",f=h>=0?"var(--success-color, #4caf50)":"var(--error-color, #e53935)",g=!!e&&!!this.hass;return z`
...
`;function er(t){const e=window;e.customCards=e.customCards||[];const i=t.type.replace("-card","").replace("equitherm-","");e.customCards.push({...t,preview:!0,documentationURL:`https://github.com/equitherm/lovelace/blob/main/docs/cards/${i}.md`})}const ir=t=>`${t}-editor`;class rr extends TypeError{constructor(t,e){let i;const{message:r,explanation:n,...o}=t,{path:s}=t,a=0===s.length?r:`At path: ${s.join(".")} -- ${r}`;super(n??a),null!=n&&(this.cause=a),Object.assign(this,o),this.name=this.constructor.name,this.failures=()=>i??(i=[t,...e()])}}function nr(t){return"object"==typeof t&&null!=t}function or(t){return nr(t)&&!Array.isArray(t)}function sr(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function ar(t,e,i,r){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:o}=e,{type:s}=i,{refinement:a,message:l=`Expected a value of type \`${s}\`${a?` with refinement \`${a}\``:""}, but received: \`${sr(r)}\``}=t;return{value:r,type:s,refinement:a,key:n[n.length-1],path:n,branch:o,...t,message:l}}function*lr(t,e,i,r){(function(t){return nr(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=ar(n,e,i,r);t&&(yield t)}}function*hr(t,e,i={}){const{path:r=[],branch:n=[t],coerce:o=!1,mask:s=!1}=i,a={path:r,branch:n,mask:s};o&&(t=e.coercer(t,a));let l="valid";for(const r of e.validator(t,a))r.explanation=i.message,l="not_valid",yield[r,void 0];for(let[h,c,u]of e.entries(t,a)){const e=hr(c,u,{path:void 0===h?r:[...r,h],branch:void 0===h?n:[...n,c],coerce:o,mask:s,message:i.message});for(const i of e)i[0]?(l=null!=i[0].refinement?"not_refined":"not_valid",yield[i[0],void 0]):o&&(c=i[1],void 0===h?t=c:t instanceof Map?t.set(h,c):t instanceof Set?t.add(c):nr(t)&&(void 0!==c||h in t)&&(t[h]=c))}if("not_valid"!==l)for(const r of e.refiner(t,a))r.explanation=i.message,l="not_refined",yield[r,void 0];"valid"===l&&(yield[void 0,t])}class cr{constructor(t){const{type:e,schema:i,validator:r,refiner:n,coercer:o=t=>t,entries:s=function*(){}}=t;this.type=e,this.schema=i,this.entries=s,this.coercer=o,this.validator=r?(t,e)=>lr(r(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>lr(n(t,e),e,this,t):()=>[]}assert(t,e){return ur(t,this,e)}create(t,e){return function(t,e,i){const r=dr(t,e,{coerce:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}is(t){return function(t,e){const i=dr(t,e);return!i[0]}(t,this)}mask(t,e){return function(t,e,i){const r=dr(t,e,{coerce:!0,mask:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}validate(t,e={}){return dr(t,this,e)}}function ur(t,e,i){const r=dr(t,e,{message:i});if(r[0])throw r[0]}function dr(t,e,i={}){const r=hr(t,e,i),n=function(t){const{done:e,value:i}=t.next();return e?void 0:i}(r);if(n[0]){const t=new rr(n[0],function*(){for(const t of r)t[0]&&(yield t[0])});return[t,void 0]}return[void 0,n[1]]}function pr(t,e){return new cr({type:t,schema:null,validator:e})}function mr(){return pr("any",()=>!0)}function _r(){return pr("boolean",t=>"boolean"==typeof t)}function fr(){return pr("number",t=>"number"==typeof t&&!isNaN(t)||`Expected a number, but received: ${sr(t)}`)}function gr(t){return new cr({...t,validator:(e,i)=>void 0===e||t.validator(e,i),refiner:(e,i)=>void 0===e||t.refiner(e,i)})}function yr(){return pr("string",t=>"string"==typeof t||`Expected a string, but received: ${sr(t)}`)}function br(t){const e=Object.keys(t);return new cr({type:"type",schema:t,*entries(i){if(nr(i))for(const r of e)yield[r,i[r],t[r]]},validator:t=>or(t)||`Expected an object, but received: ${sr(t)}`,coercer:t=>or(t)?{...t}:t})}const vr=br({type:yr(),climate_entity:yr(),outdoor_entity:yr(),flow_entity:yr(),curve_output_entity:gr(yr()),pid_output_entity:gr(yr()),rate_limiting_entity:gr(yr()),pid_active_entity:gr(yr()),pid_correction_entity:gr(yr()),wws_entity:gr(yr()),hc_entity:gr(yr()),shift_entity:gr(yr()),n_entity:gr(yr()),show_last_updated:gr(_r()),show_params_footer:gr(_r()),tunable:gr(_r()),recalculate_service:gr(yr()),name:gr(mr())});function wr(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,ur(e,vr),e}const Er="equitherm",xr=`${Er}-status-card`,$r=ir(xr),Sr=["climate"],Tr=["sensor"];function Cr(t){return Object.keys(t.states).find(t=>Sr.includes(It(t)))}function Ar(t){return Object.keys(t.states).find(t=>"weather"===It(t))}function Hr(t){const e=t.states;return Object.keys(e).filter(t=>{const i=e[t];return Tr.includes(It(t))&&"temperature"===i?.attributes?.device_class})}function Nr(t){const e=Hr(t);return e.find(t=>t.includes("outdoor")||t.includes("outside")||t.includes("exterior"))??e[0]}function Pr(t){const e=Hr(t);return e.find(t=>t.includes("flow")||t.includes("supply")||t.includes("forward"))??e[0]}function Dr(t){return Hr(t).find(t=>t.includes("curve_output"))??""}let kr=class extends lt{constructor(){super(...arguments),this.label="",this.active=!1}static get styles(){return a`
      :host {
    ...
    `}};function Kr(t,e,i=10,r=1){return{min:Math.floor((t-r)/i)*i,max:Math.ceil((e+r)/i)*i}}t([mt()],Xr.prototype,"_active",void 0),Xr=t([ct("eq-manual-overlay")],Xr),er({type:Gr,name:"Equitherm Curve",description:"Heating curve visualization with current operating point"});let Yr=class extends Ki{willUpdate(t){if(super.willUpdate(t),t.has("_config"))return this._applyGradientColors(),void this._updateChartConfig();if(t.has("hass")&&this.hass){const e=t.get("hass");e&&!this._relevantStateChanged(e)||this._updateChartConfig()}}_relevantStateChanged(t){return[this._config.outdoor_entity,this._config.flow_entity,this._config.climate_entity,this._config.rate_limiting_entity,this._config.pid_output_entity,this._config.curve_output_entity,this._config.pid_active_entity,...this._config.curve_from_entities||this._config.tunable?[this._config.hc_entity,this._config.shift_entity,this._config.n_entity,this._config.min_flow_entity,this._config.max_flow_entity]:[]].filter(Boolean).some(e=>this.hass.states[e]?.state!==t.states[e]?.state)}_applyGradientColors(){this._setColorVar("--curve-gradient-start",this._config.gradient_warm_color),this._setColorVar("--curve-gradient-end",this._config.gradient_cool_color)}_setColorVar(t,e){if(!e)return void this.style.removeProperty(t);const i=this._resolveToRgbTriple(e);i&&this.style.setProperty(t,i)}_resolveToRgbTriple(t){if(t.startsWith("#"))return this._hexToRgbTriple(t);const e=getComputedStyle(document.body).getPropertyValue(`--${t}-color`).trim();return e?this._hexToRgbTriple(e):void 0}_hexToRgbTriple(t){const e=t.match(/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i);if(e)return`${parseInt(e[1],16)}, ${parseInt(e[2],16)}, ${parseInt(e[3],16)}`}static async getStubConfig(t){return{type:"custom:equitherm-curve-card",climate_entity:Cr(t),outdoor_entity:Nr(t),curve_output_entity:Dr(t),flow_entity:Pr(t),hc:1.2,n:1.25,shift:0,min_flow:25,max_flow:70,t_out_min:-20,t_out_max:20}}static async getConfigElement(){return await Promise.resolve().then(function(){return ln}),document.createElement(zr)}setConfig(t){this._config=Wr(t),this._dialogConfig=Ur(this._config)}_lastUpdatedEntity(){return this._config.flow_entity}get _tTarget(){return this._climate?.attributes.temperature??21}get _tOutdoor(){const t=this._entityState(this._config.outdoor_entity);if(!t)return null;const e=parseFloat(t.state);return isNaN(e)?null:this._fromDisplayTemp(e)}get _flowTemp(){const t=this._entityState(this._config.flow_entity);if(t){const e=parseFloat(t.state);if(!isNaN(e))return this._fromDisplayTemp(e)}return this._config.min_flow}get _currentN(){return this._config.curve_from_entities?this._resolveEntityNumber(this._config.n_entity,this._config.n):this._config.n}_renderParamsFooterContent(){return this._config.curve_from_entities?this._renderTunableParamsFooter({hc:this._config.hc_entity?{entity:this._config.hc_entity,fallback:this._config.hc,onClick:this._config.tunable?void 0:()=>{this._showTuningDialog=!0}}:void 0,n:this._config.n_entity?{entity:this._config.n_entity,fallback:this._config.n}:void 0,shift:this._config.shift_entity?{entity:this._config.shift_entity,fallback:this._config.shift,onClick:this._config.tunable?void 0:()=>{this._showTuningDialog=!0}}:void 0},()=>{this._showTuningDialog=!0}):V}_buildEChartOptions(){return this._buildSingleCurveOptions()}_buildSingleCurveOptions(){const t=Bi(this.hass),e=this._config,i={tTarget:this._tTarget,hc:e.curve_from_entities?this._resolveEntityNumber(e.hc_entity,e.hc):e.hc,n:e.curve_from_entities?this._resolveEntityNumber(e.n_entity,e.n):e.n,shift:e.curve_from_entities?this._resolveEntityTemp(e.shift_entity,e.shift):e.shift,minFlow:e.curve_from_entities?this._resolveEntityTemp(e.min_flow_entity,e.min_flow):e.min_flow,maxFlow:e.curve_from_entities?this._resolveEntityTemp(e.max_flow_entity,e.max_flow):e.max_flow},r=getComputedStyle(this),n=r.getPropertyValue("--curve-gradient-start").trim(),o=r.getPropertyValue("--curve-gradient-end").trim(),s=n?`rgb(${n})`:Ui(this,"heating"),a=o?`rgb(${o})`:Ui(this,"cooling"),l=`rgba(${r.getPropertyValue("--rgb-warning").trim()||"255, 167, 38"}, 0.08)`,h=Mr(i,e.t_out_min,e.t_out_max).map(t=>({x:this._toDisplayTemp(t.x),y:this._toDisplayTemp(t.y)})),c=this._tOutdoor,u=[],d=qi(this._config,t=>this._entityState(t)),p=Gi(this._config);if(null!==c){const t=this._toDisplayTemp(c),e=Ir(i,c),r=this._toDisplayTemp(e);if(d){const e=p&&this._entityState(p)?parseFloat(this._entityState(p).state):r;if(this._config.pid_output_entity&&this._config.curve_output_entity){const e=this._entityState(this._config.curve_output_entity),i=e?parseFloat(e.state):r;u.push({value:[t,i],symbolSize:8,itemStyle:{color:"transparent",borderColor:s,borderWidth:1.5}})}u.push({value:[t,e],symbolSize:10,itemStyle:{color:s,borderColor:"#ffffff",borderWidth:2}}),u.push({value:[t,this._toDisplayTemp(this._flowTemp)],symbolSize:8,itemStyle:{color:"transparent",borderColor:s,borderWidth:2}})}else u.push({value:[t,r],symbolSize:9,itemStyle:{color:s,borderColor:"#ffffff",borderWidth:2}})}const m=Kr(i.minFlow,i.maxFlow),_=this._toDisplayTemp(m.min),f=this._toDisplayTemp(m.max),g=h.filter((t,e)=>e%50==0).map(t=>[t.x,t.y]);return{options:{animation:!1,xAxis:{type:"value",min:this._toDisplayTemp(e.t_out_min),max:this._toDisplayTemp(e.t_out_max),inverse:!0,axisLabel:{fontSize:10,formatter:t=>`${parseFloat(t.toFixed(1))}`},axisTick:{show:!1},axisLine:{show:!1}},yAxis:{type:"value",axisLabel:{fontSize:10,formatter:t=>`${parseFloat(t.toFixed(1))}`},min:_,max:f},grid:{top:5,right:5,bottom:20,left:30},tooltip:{trigger:"axis",backgroundColor:"rgba(var(--rgb-card-background-color, 255, 255, 255), 0.95)",borderColor:"var(--divider-color, rgba(0,0,0,0.12))",borderWidth:1,padding:[8,12],textStyle:{color:"var(--primary-text-color)",fontSize:12},formatter:e=>{const i=(Array.isArray(e)?e:[]).find(e=>e.seriesName===t("curve_card.flow_temp"));if(!i)return"";const r=i.value[0],n=i.value[1],o=this.hass?.config?.unit_system?.temperature??"°C",a=t=>`${parseFloat(t.toFixed(1))} ${o}`;return`<div style="margin-bottom:4px;font-weight:600">${a(r)} ${t("curve_card.outdoor_axis_suffix")}</div><div>${l=s,`<span style="display:inline-block;margin-right:6px;border-radius:50%;width:8px;height:8px;background-color:${l}"></span>`}${a(n)} ${t("curve_card.flow_axis_suffix")}</div>`;var l}},legend:{show:!1}},data:[{type:"line",name:t("curve_card.flow_temp"),data:h.map(t=>[t.x,t.y]),showSymbol:!1,lineStyle:{width:2},itemStyle:{color:s},areaStyle:{color:{type:"linear",x:0,y:0,x2:1,y2:0,colorStops:[{offset:0,color:s},{offset:1,color:a}]}}},{type:"line",name:"markers",data:g,showSymbol:!0,symbol:"circle",symbolSize:3,lineStyle:{width:0},itemStyle:{color:s,borderColor:"#fff",borderWidth:1},tooltip:{show:!1}},{type:"line",name:"operating-point",data:u,showSymbol:!0,symbol:"circle",lineStyle:{width:0},tooltip:{show:!1}},...this._isWWSD?[{type:"line",name:"wwsd",data:[[this._toDisplayTemp(e.t_out_max),f],[this._toDisplayTemp(this._tTarget),f]],showSymbol:!1,lineStyle:{width:0},areaStyle:{color:l},tooltip:{show:!1}}]:[]]}}_renderChart(){if(!this._echartConfig)return V;const{options:t,data:e}=this._echartConfig;return z`
      <div class="chart-wrapper ${Xi({"has-fixed-height":this._hasFixedHeight})}">
        <ha-chart-base
          .hass=${this.hass}
          .options=${t}
    ...
    `}_onChartDisconnecting(){this._unsubscribeForecast()}_onChartReconnected(){this._subscribeForecast()}static get styles(){return[super.styles,Zi,Vi,Qi,Ji,tr,a`
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};t([mt()],rn.prototype,"_forecastPoints",void 0),rn=t([ct(Zr)],rn),console.info("%c EQUITHERM-CARDS %c 1.6.0 ","color: white; background: #f97316; font-weight: bold;","color: #f97316; background: white; font-weight: bold;");const nn={entity:function(t,e={}){return{name:t,required:e.required??!0,selector:{entity:{domain:e.domain,device_class:e.device_class}}}},number:function(t,e,i,r=1,n={}){return{name:t,required:n.required??!1,...void 0!==n.default&&{default:n.default},selector:{number:{min:e,max:i,step:r,mode:n.mode??"box",unit_of_measurement:n.unit_of_measurement}}}},text:function(t,e=!1){return{name:t,required:e,selector:{text:{}}}},entityName:function(t,e){return{name:t,selector:{entity_name:{}},context:e}},grid:function(t){return{type:"grid",name:"",schema:t}},expandable:function(t,e,i){return{type:"expandable",flatten:!0,title:t,icon:e,name:"",schema:i}}};let on=class extends Yi{constructor(){super(...arguments),this._schemaMemo=Xt(t=>{const e=Bi(this.hass);return[nn.entity("climate_entity",{domain:"climate"}),nn.entityName("name",{entity:"climate_entity"}),nn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),nn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...t?[nn.expandable(e("editor.tuning"),"mdi:tune-variant",[nn.entity("hc_entity",{domain:["number","input_number"]}),nn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],nn.expandable(e("editor.optional"),"mdi:connection",[nn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),nn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),nn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),nn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),nn.entity("wws_entity",{domain:["binary_sensor"],required:!1}),nn.entity("pid_correction_entity",{domain:["sensor","input_number"],device_class:"temperature",required:!1})]),nn.expandable(e("editor.curve_parameters"),"mdi:chart-bell-curve-cumulative",[nn.entity("hc_entity",{domain:["number","input_number"],required:!1}),nn.entity("shift_entity",{domain:["number","input_number"],required:!1}),nn.entity("n_entity",{domain:["number","input_number"],required:!1})])]})}setConfig(t){this._config={...t}}_validate(t){wr(t)}_getSchema(){return this._schemaMemo(!!this._config.tunable)}};on=t([ct($r)],on);var sn=Object.freeze({__proto__:null,get StatusCardEditor(){return on}});let an=class extends Yi{constructor(){super(...arguments),this._schemaMemo=Xt((t,e,i)=>{const r=this.hass?.config?.unit_system?.temperature??"°C",n=t=>Math.round(10*xt(t,i))/10,o=t=>Math.round(10*St(t,i))/10,s=Bi(this.hass);return[nn.entity("climate_entity",{domain:"climate"}),nn.entityName("name",{entity:"climate_entity"}),nn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),nn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),nn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"tunable",selector:{boolean:{}},default:!1},{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},...e?[nn.expandable(s("editor.tuning"),"mdi:tune-variant",[nn.entity("hc_entity",{domain:["number","input_number"]}),nn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],nn.expandable(s("editor.optional"),"mdi:connection",[nn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),nn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),nn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),nn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),nn.expandable(s("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[nn.entity("hc_entity",{domain:"number"}),nn.entity("n_entity",{domain:"number"}),nn.entity("shift_entity",{domain:"number"}),nn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),nn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[nn.grid([nn.number("hc",.5,3,.1,{default:.9}),nn.number("n",1,2,.05,{default:1.25})]),nn.number("shift",o(-15),o(15),1,{unit_of_measurement:r,default:o(0)}),nn.grid([nn.number("min_flow",n(15),n(35),1,{unit_of_measurement:r,default:n(20)}),nn.number("max_flow",n(50),n(90),1,{unit_of_measurement:r,default:n(70)})])]]),nn.expandable(s("editor.display_range"),"mdi:arrow-expand-horizontal",[nn.grid([nn.number("t_out_min",n(-30),n(5),1,{unit_of_measurement:r,default:n(-20)}),nn.number("t_out_max",n(0),n(30),1,{unit_of_measurement:r,default:n(20)})])]),nn.expandable(s("editor.appearance"),"mdi:palette-outline",[{name:"gradient_warm_color",selector:{ui_color:{}}},{name:"gradient_cool_color",selector:{ui_color:{}}}])]})}setConfig(t){this._config={...t}}_validate(t){Wr(t)}_transformConfig(t){if(!Et(this.hass))return t;const e={...t};null!=e.shift&&(e.shift=Tt(e.shift,!0));for(const t of["min_flow","max_flow","t_out_min","t_out_max"])null!=e[t]&&(e[t]=$t(e[t],!0));return e}_getDisplayConfig(){if(!Et(this.hass))return this._config;const t={...this._config};null!=t.shift&&(t.shift=Math.round(10*St(t.shift,!0))/10);for(const e of["min_flow","max_flow","t_out_min","t_out_max"])null!=t[e]&&(t[e]=Math.round(10*xt(t[e],!0))/10);return t}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable,Et(this.hass))}};an=t([ct(zr)],an);var ln=Object.freeze({__proto__:null,get EquithermCurveCardEditor(){return an}});let hn=class extends Yi{constructor(){super(...arguments),this._schemaMemo=Xt((t,e)=>{const i=Bi(this.hass);return[nn.entity("weather_entity",{domain:"weather"}),nn.entity("climate_entity",{domain:"climate"}),nn.entityName("name",{entity:"climate_entity"}),nn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...e?[nn.expandable(i("editor.tuning"),"mdi:tune-variant",[nn.entity("hc_entity",{domain:["number","input_number"]}),nn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],nn.expandable(i("editor.optional"),"mdi:connection",[nn.entity("outdoor_entity",{domain:["sensor","number","input_number"],device_class:"temperature",required:!1}),nn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),nn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),nn.expandable(i("editor.forecast_settings"),"mdi:clock-outline",[nn.number("hours",1,48,1,{unit_of_measurement:"h",default:24})]),nn.expandable(i("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[nn.entity("hc_entity",{domain:"number"}),nn.entity("n_entity",{domain:"number"}),nn.entity("shift_entity",{domain:"number"}),nn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),nn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[nn.grid([nn.number("hc",.5,3,.1,{default:.9}),nn.number("n",1,2,.05,{default:1.25})]),nn.number("shift",-15,15,1,{unit_of_measurement:"°C",default:0}),nn.grid([nn.number("min_flow",15,35,1,{unit_of_measurement:"°C",default:20}),nn.number("max_flow",50,90,1,{unit_of_measurement:"°C",default:70})])]])]})}setConfig(t){this._config={...t}}_validate(t){en(t)}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable)}};hn=t([ct(Jr)],hn);var cn=Object.freeze({__proto__:null,get EquithermForecastCardEditor(){return hn}});

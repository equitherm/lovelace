...
`;class Wi extends Bi{constructor(){super(...arguments),this._showTuningDialog=!1,this._openTuningDialog=()=>{this._showTuningDialog=!0},this._onDeltaParamChanged=t=>{const e=t.target.dataset.entityId;if(!e||!this.hass)return;const i=this._fromDisplayDelta(t.detail.value);this.hass.callService(Ot(e),"set_value",{entity_id:e,value:i})},this._onParamChanged=t=>{const e=t.target.dataset.entityId;e&&this.hass&&this.hass.callService(Ot(e),"set_value",{entity_id:e,value:t.detail.value})}}get _climate(){return this._entityState(this._config.climate_entity)}get _isManualPreset(){return"Manual"===this._climate?.attributes.preset_mode}updated(t){super.updated(t),t.has("hass")&&this.hass&&this.toggleAttribute("manual-override",this._isManualPreset)}get _roomTemp(){const t=this._climate?.attributes.current_temperature;return this._formatCalcTemp(t)}get _outdoorTempFormatted(){return this._formatEntityTemp(this._config.outdoor_entity)}get _flowTempFormatted(){return this._formatEntityTemp(this._config.flow_entity)}get _curveOutputTempFormatted(){const t=Gi(this._config);return t?this._formatEntityTemp(t):""}get _isWWSD(){if(this._config?.wws_entity){const t=this._entityState(this._config.wws_entity);return"on"===t?.state}if(!this._config?.climate_entity)return!1;const t=this._climate?.attributes.temperature;if(null==t)return!1;if(!this._config.outdoor_entity)return!1;const e=this._entityState(this._config.outdoor_entity);if(!e)return!1;const i=parseFloat(e.state),r=isNaN(i)?NaN:this._fromDisplayTemp(i);return!isNaN(r)&&r>=t}_wwsdDescription(){const t=Mi(this.hass),e=this._climate?.attributes.temperature,i=this._config.outdoor_entity,r=i?this._entityState(i):void 0,n=r?this._fromDisplayTemp(parseFloat(r.state)):NaN;return isNaN(n)||null==e?t("common.wwsd_label"):`${t("common.outdoor")} ${this._formatEntityTemp(i)} ≥ ${this._formatCalcTemp(e)}`}_renderNotFound(t,e){if(!t||this._entityExists(t))return V;const i=Mi(this.hass);return z`
    ...
    `}_renderManualBadge(){if(!this._isManualPreset)return V;const t=Mi(this.hass);return z`
      ...
      ></eq-badge-info>
    `}_renderHvacBadge(){const t=Mi(this.hass),e=Fi(this._climate?.attributes.hvac_action??"off"),i=t=>this._entityState(t),r=this._config,n=function(t,e,i=!1,r=null){if(i){const e="rising"===r?"mdi:trending-up":"falling"===r?"mdi:trending-down":"mdi:trending-neutral";return{label:t("common.adjusting"),color:Ri("heating"),icon:e,active:!0}}return{label:t({heating:"common.heating",cooling:"common.cooling",drying:"common.drying",idle:"common.idle",off:"common.off",fan:"common.fan",defrosting:"common.defrosting",preheating:"common.preheating"}[e]),color:Ri(e),icon:Ii(e)??void 0,active:Li.has(e)}}(t,e,Ui(r,i),zi(r,i));return z`
      <eq-badge-info
        .label=${n.label}
    ...
    `}_renderKpiFooter(t){if(!1===this._config.show_kpi_footer)return V;if(!this._config||!this.hass)return V;const e=Mi(this.hass),i=t?.outdoorClickEntity??this._config.outdoor_entity,r=!this._entityExists(i),n=!this._entityExists(this._config.flow_entity),o=!this._entityExists(this._config.climate_entity);return z`
    ...
    `}_getEntityRange(t,e,i){if(!t)return[e,i];return[this._entityAttr(t,"min")??e,this._entityAttr(t,"max")??i]}_getEntityStep(t,e){return t?this._entityAttr(t,"step")??e:e}_formatParamNum(t,e,i){return Qt(t,this.hass?.locale,{minimumFractionDigits:e,maximumFractionDigits:e,...i})}_renderDeltaParamItem(t,e,i,r,n){const o=this._resolveEntityNumber(e,i),[s,a]=this._getEntityRange(e,r[0],r[1]),l=this._getEntityStep(e,1),c=this._toDisplayDelta(o),h=this._toDisplayDelta(s),u=this._toDisplayDelta(a),d=this._toDisplayDelta(l),p=this.hass?.config?.unit_system?.temperature??"°C",m=this._formatParamNum(c,1,{signDisplay:"always"})+p,_=c>0?"positive":c<0?"negative":"",f=c>=0?"var(--success-color, #4caf50)":"var(--error-color, #e53935)",g=!!e&&!!this.hass;return z`
...
const Xi=Nt(class extends Dt{constructor(t){if(super(t),t.type!==At||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const r=!!e[t];r===this.st.has(t)||this.nt?.has(t)||(r?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return j}});class Ki extends Wi{getGridOptions(){return{columns:12,rows:"auto",min_rows:3}}getCardSize(){return 3}get _hasFixedHeight(){const t=this._config?.grid_options,e=t?.rows;return"number"==typeof e}_formatChartTime(t){return Yt(new Date(t),this.hass.locale)}_formatChartDateTime(t){const e=new Date(t);return`${e.toLocaleDateString(this.hass?.locale?.language,{weekday:"short"})} ${Yt(e,this.hass.locale)}`}_updateChartConfig(){this._config&&this.hass&&(this._echartConfig=this._buildEChartOptions())}updated(t){if(super.updated(t),t.has("hass")){const e=t.get("hass"),i=e&&this.hass?.config?.unit_system?.temperature!==e.config?.unit_system?.temperature,r=e&&this.hass?.locale?.time_format!==e.locale?.time_format;(i||r)&&this._updateChartConfig()}}_onChartReconnected(){}_onChartDisconnecting(){}connectedCallback(){super.connectedCallback(),this._config&&this.hass&&this._onChartReconnected()}disconnectedCallback(){this._onChartDisconnecting(),super.disconnectedCallback()}_renderChart(){if(!this._echartConfig)return V;const{options:t,data:e}=this._echartConfig;return z`
  ...
  `,t([pt({attribute:!1})],Zi.prototype,"hass",void 0),t([mt()],Zi.prototype,"_config",void 0),t([mt()],Zi.prototype,"_error",void 0);const Ji=a`
  :host {
...
`;function ir(t){const e=window;e.customCards=e.customCards||[];const i=t.type.replace("-card","").replace("equitherm-","");e.customCards.push({...t,preview:!0,documentationURL:`https://github.com/equitherm/lovelace/blob/main/docs/cards/${i}.md`})}const rr=t=>`${t}-editor`;class nr extends TypeError{constructor(t,e){let i;const{message:r,explanation:n,...o}=t,{path:s}=t,a=0===s.length?r:`At path: ${s.join(".")} -- ${r}`;super(n??a),null!=n&&(this.cause=a),Object.assign(this,o),this.name=this.constructor.name,this.failures=()=>i??(i=[t,...e()])}}function or(t){return"object"==typeof t&&null!=t}function sr(t){return or(t)&&!Array.isArray(t)}function ar(t){return"symbol"==typeof t?t.toString():"string"==typeof t?JSON.stringify(t):`${t}`}function lr(t,e,i,r){if(!0===t)return;!1===t?t={}:"string"==typeof t&&(t={message:t});const{path:n,branch:o}=e,{type:s}=i,{refinement:a,message:l=`Expected a value of type \`${s}\`${a?` with refinement \`${a}\``:""}, but received: \`${ar(r)}\``}=t;return{value:r,type:s,refinement:a,key:n[n.length-1],path:n,branch:o,...t,message:l}}function*cr(t,e,i,r){(function(t){return or(t)&&"function"==typeof t[Symbol.iterator]})(t)||(t=[t]);for(const n of t){const t=lr(n,e,i,r);t&&(yield t)}}function*hr(t,e,i={}){const{path:r=[],branch:n=[t],coerce:o=!1,mask:s=!1}=i,a={path:r,branch:n,mask:s};o&&(t=e.coercer(t,a));let l="valid";for(const r of e.validator(t,a))r.explanation=i.message,l="not_valid",yield[r,void 0];for(let[c,h,u]of e.entries(t,a)){const e=hr(h,u,{path:void 0===c?r:[...r,c],branch:void 0===c?n:[...n,h],coerce:o,mask:s,message:i.message});for(const i of e)i[0]?(l=null!=i[0].refinement?"not_refined":"not_valid",yield[i[0],void 0]):o&&(h=i[1],void 0===c?t=h:t instanceof Map?t.set(c,h):t instanceof Set?t.add(h):or(t)&&(void 0!==h||c in t)&&(t[c]=h))}if("not_valid"!==l)for(const r of e.refiner(t,a))r.explanation=i.message,l="not_refined",yield[r,void 0];"valid"===l&&(yield[void 0,t])}class ur{constructor(t){const{type:e,schema:i,validator:r,refiner:n,coercer:o=t=>t,entries:s=function*(){}}=t;this.type=e,this.schema=i,this.entries=s,this.coercer=o,this.validator=r?(t,e)=>cr(r(t,e),e,this,t):()=>[],this.refiner=n?(t,e)=>cr(n(t,e),e,this,t):()=>[]}assert(t,e){return dr(t,this,e)}create(t,e){return function(t,e,i){const r=pr(t,e,{coerce:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}is(t){return function(t,e){const i=pr(t,e);return!i[0]}(t,this)}mask(t,e){return function(t,e,i){const r=pr(t,e,{coerce:!0,mask:!0,message:i});if(r[0])throw r[0];return r[1]}(t,this,e)}validate(t,e={}){return pr(t,this,e)}}function dr(t,e,i){const r=pr(t,e,{message:i});if(r[0])throw r[0]}function pr(t,e,i={}){const r=hr(t,e,i),n=function(t){const{done:e,value:i}=t.next();return e?void 0:i}(r);if(n[0]){const t=new nr(n[0],function*(){for(const t of r)t[0]&&(yield t[0])});return[t,void 0]}return[void 0,n[1]]}function mr(t,e){return new ur({type:t,schema:null,validator:e})}function _r(){return mr("any",()=>!0)}function fr(){return mr("boolean",t=>"boolean"==typeof t)}function gr(){return mr("number",t=>"number"==typeof t&&!isNaN(t)||`Expected a number, but received: ${ar(t)}`)}function yr(t){return new ur({...t,validator:(e,i)=>void 0===e||t.validator(e,i),refiner:(e,i)=>void 0===e||t.refiner(e,i)})}function br(){return mr("string",t=>"string"==typeof t||`Expected a string, but received: ${ar(t)}`)}function vr(t){const e=Object.keys(t);return new ur({type:"type",schema:t,*entries(i){if(or(i))for(const r of e)yield[r,i[r],t[r]]},validator:t=>sr(t)||`Expected an object, but received: ${ar(t)}`,coercer:t=>sr(t)?{...t}:t})}function wr(){return mr("unknown",()=>!0)}const xr=vr({type:br(),climate_entity:br(),outdoor_entity:br(),flow_entity:br(),curve_output_entity:yr(br()),pid_output_entity:yr(br()),rate_limiting_entity:yr(br()),pid_active_entity:yr(br()),pid_correction_entity:yr(br()),wws_entity:yr(br()),hc_entity:yr(br()),shift_entity:yr(br()),n_entity:yr(br()),show_last_updated:yr(fr()),show_params_footer:yr(fr()),tunable:yr(fr()),recalculate_service:yr(br()),name:yr(_r())});function Er(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,dr(e,xr),e}const $r="equitherm",Tr=`${$r}-status-card`,Cr=rr(Tr),Sr=["climate"],Hr=["sensor"];function Ar(t){return Object.keys(t.states).find(t=>Sr.includes(Ot(t)))}function Nr(t){return Object.keys(t.states).find(t=>"weather"===Ot(t))}function Dr(t){const e=t.states;return Object.keys(e).filter(t=>{const i=e[t];return Hr.includes(Ot(t))&&"temperature"===i?.attributes?.device_class})}function Pr(t){const e=Dr(t);return e.find(t=>t.includes("outdoor")||t.includes("outside")||t.includes("exterior"))??e[0]}function kr(t){const e=Dr(t);return e.find(t=>t.includes("flow")||t.includes("supply")||t.includes("forward"))??e[0]}function Mr(t){return Dr(t).find(t=>t.includes("curve_output"))??""}let Br=class extends lt{constructor(){super(...arguments),this.label="",this.active=!1}static get styles(){return a`
      :host {
          ...
          <div class="ctrl-panel">
            ...
            <div class="hero-row">
              ...
              ${Math.abs(s)>this._shiftStep/2?z`
                <span class="ctrl-delta ${s>0?"pos":"neg"}">${Qt(this._toDisplayDelta(s),this.hass?.locale,{minimumFractionDigits:r,maximumFractionDigits:r,signDisplay:"always"})}${this.hass?.config?.unit_system?.temperature??"°C"}</span>
              `:V}
            </div>
            <eq-param-bar
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}};t([pt({attribute:!1})],Rr.prototype,"hass",void 0),t([pt({attribute:!1})],Rr.prototype,"config",void 0),t([pt({type:Boolean})],Rr.prototype,"open",void 0),t([mt()],Rr.prototype,"_proposedHc",void 0),t([mt()],Rr.prototype,"_proposedShift",void 0),t([mt()],Rr.prototype,"_applying",void 0),t([mt()],Rr.prototype,"_applySuccess",void 0),t([mt()],Rr.prototype,"_chartConfig",void 0),Rr=t([ht("eq-tuning-dialog")],Rr);const Lr={n:1.25,min_flow:20,max_flow:70,t_out_min:-20,t_out_max:20},qr={n:yr(gr()),min_flow:yr(gr()),max_flow:yr(gr()),t_out_min:yr(gr()),t_out_max:yr(gr())},Ur={min_flow_entity:yr(br()),max_flow_entity:yr(br())};function Gr(t){const e=t.hc_entity,i=t.shift_entity;if(e&&i)return{climate_entity:t.climate_entity,outdoor_entity:t.outdoor_entity,flow_entity:t.flow_entity,hc_entity:e,shift_entity:i,n_entity:t.n_entity,min_flow_entity:t.min_flow_entity,max_flow_entity:t.max_flow_entity,recalculate_service:t.recalculate_service,curve_from_entities:t.curve_from_entities??!!t.n_entity,n:t.n??Lr.n,min_flow:t.min_flow??Lr.min_flow,max_flow:t.max_flow??Lr.max_flow,t_out_min:t.t_out_min??Lr.t_out_min,t_out_max:t.t_out_max??Lr.t_out_max}}ir({type:Tr,name:"Equitherm Status",description:"Compact heating status tile with temperature displays"});let zr=class extends Wi{getGridOptions(){return{columns:12,rows:this._config.show_last_updated?4:3,min_rows:3}}static async getStubConfig(t){return{type:"custom:equitherm-status-card",climate_entity:Ar(t),outdoor_entity:Pr(t),flow_entity:kr(t)}}static async getConfigElement(){return await Promise.resolve().then(function(){return Mn}),document.createElement(Cr)}setConfig(t){this._config=Er(t),this._dialogConfig=Gr(this._config)}_lastUpdatedEntity(){return this._config.flow_entity}get _hasParamsFooter(){const t=this._config;return!!(t.hc_entity||t.shift_entity||t.n_entity||t.pid_correction_entity)}static get styles(){return[super.styles,Ji,Vi,tr,er,Qi,a`
        ha-card {
          height: 100%;
          display: flex;
          flex-direction: column;
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};zr=t([ht(Tr)],zr);const jr=`${$r}-curve-card`,Vr=rr(jr),Wr=vr({type:br(),climate_entity:br(),outdoor_entity:br(),curve_output_entity:yr(br()),pid_output_entity:yr(br()),flow_entity:br(),rate_limiting_entity:yr(br()),pid_active_entity:yr(br()),wws_entity:yr(br()),show_last_updated:yr(fr()),show_kpi_footer:yr(fr()),show_params_footer:yr(fr()),name:yr(_r()),curve_from_entities:yr(_r()),hc_entity:yr(br()),n_entity:yr(br()),shift_entity:yr(br()),tunable:yr(fr()),recalculate_service:yr(br()),...Ur,hc:yr(gr()),shift:yr(gr()),...qr,gradient_warm_color:yr(br()),gradient_cool_color:yr(br())}),Xr={hc:.9,shift:0,...Lr};function Kr(t){const e={...t};return"title"in e&&!("name"in e)&&(e.name=e.title),delete e.title,dr(e,Wr),{...Xr,...e}}let Yr=class extends lt{constructor(){super(...arguments),this._active=!1}connectedCallback(){super.connectedCallback();const t=this.getRootNode();this._hostEl=t.host,this._hostEl&&(this._active=this._hostEl.hasAttribute("manual-override"),this._observer=new MutationObserver(()=>{this._active=this._hostEl.hasAttribute("manual-override")}),this._observer.observe(this._hostEl,{attributes:!0,attributeFilter:["manual-override"]}))}disconnectedCallback(){this._observer?.disconnect(),super.disconnectedCallback()}static get styles(){return a`
      :host {
        position: absolute;
        inset: 0;
        display: flex;
    ...
    `}static get styles(){return[super.styles,Ji,Vi,tr,er,Qi,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }
    ...
    `}_onChartDisconnecting(){this._unsubscribeForecast()}_onChartReconnected(){this._subscribeForecast()}static get styles(){return[super.styles,Ji,Vi,tr,Qi,er,a`
        ha-card {
          height: 100%;
          overflow: hidden;
        }
      ...
      ${this._dialogConfig&&this._showTuningDialog?z`
        ...
        ></eq-tuning-dialog>
      `:V}
    `}};t([mt()],on.prototype,"_forecastPoints",void 0),on=t([ht(Qr)],on);const sn=["binary_sensor","input_boolean"],an=["sensor","input_number"],ln=["number","input_number"],cn="opentherm-status-card",hn=rr(cn),un=vr({type:br(),boiler_temp_entity:br(),return_temp_entity:br(),flame_entity:br(),setpoint_entity:yr(br()),modulation_entity:yr(br()),ch_active_entity:yr(br()),dhw_active_entity:yr(br()),name:yr(wr()),show_last_updated:yr(fr())});function dn(t){return dr(t,un),t}ir({type:cn,name:"OpenTherm Status",description:"Boiler status at a glance"});let pn=class extends Yi{static async getStubConfig(t){const e=Object.keys(t.states),i=e.filter(t=>an.includes(Ot(t))),r=e.filter(t=>sn.includes(Ot(t))),n=i.find(t=>t.includes("boiler")||t.includes("t_boiler"))??i[0]??"",o=i.find(t=>t.includes("ret")||t.includes("return"))??i[1]??"",s=r.find(t=>t.includes("flame"))??r[0]??"";return{type:`custom:${cn}`,boiler_temp_entity:n,return_temp_entity:o,flame_entity:s}}static async getConfigElement(){return await Promise.resolve().then(function(){return Ln}),document.createElement(hn)}setConfig(t){this._config=dn(t)}getGridOptions(){return{columns:12,rows:3,min_rows:1}}get _flameOn(){return"on"===this._entityState(this._config.flame_entity)?.state}get _boilerTemp(){return this._resolveEntityNumber(this._config.boiler_temp_entity,NaN)}get _returnTemp(){return this._resolveEntityNumber(this._config.return_temp_entity,NaN)}get _deltaT(){return this._boilerTemp-this._returnTemp}get _formattedDeltaT(){const t=this._deltaT;if(isNaN(t))return"—";const e=this.hass?.config?.unit_system?.temperature??"°C";return`${Qt(t,this.hass?.locale,{minimumFractionDigits:1,maximumFractionDigits:1,signDisplay:"always"})} ${e}`}get _modulation(){return this._config.modulation_entity?this._resolveEntityNumber(this._config.modulation_entity,NaN):NaN}_titleEntity(){return this._config.boiler_temp_entity}_headerIconColor(){return this._flameOn?"var(--rgb-state-climate-heat, 244,81,30)":"var(--rgb-disabled, 158,158,158)"}_renderHeaderBadges(){const t=Mi(this.hass),e=this._config,i=!!e.ch_active_entity&&"on"===this._entityState(e.ch_active_entity)?.state,r=!!e.dhw_active_entity&&"on"===this._entityState(e.dhw_active_entity)?.state;return z`
      <div class="badges">
        ${this._flameOn?z`
          <eq-badge-info
    ...
    `}_lastUpdatedEntity(){return this._config.boiler_temp_entity}static get styles(){return[super.styles,Ji,Vi,a`
        ha-card { height: 100%; }
      ...
      `]}render(){if(!this._config||!this.hass)return V;const t=Mi(this.hass),e=this._config,i=this._flameOn,r=this._boilerTemp,n=this._returnTemp;this._deltaT;const o=this._modulation,s=e.setpoint_entity?this._resolveEntityNumber(e.setpoint_entity,NaN):NaN,a=t=>isNaN(t)?"—":this._formatCalcTemp(t),l=this._computeCardTitle("opentherm.status_card.default_title");return z`
      <ha-card>
        ...
        <div class="body">
          ...
          ${isNaN(o)?V:z`
            <div class="mod-row">
              ...
              <span class="mod-value">${Qt(o,this.hass?.locale,{maximumFractionDigits:0})}%</span>
            </div>
          `}
        </div>
        ${this._renderFooterMeta()}
      </ha-card>
    `}};pn=t([ht(cn)],pn);const mn="opentherm-dhw-card",_n=rr(mn),fn=["switch","input_boolean"],gn=vr({type:br(),dhw_enable_entity:br(),dhw_setpoint_entity:br(),dhw_active_entity:yr(br()),dhw_temp_entity:yr(br()),name:yr(wr()),show_last_updated:yr(fr())});function yn(t){return dr(t,gn),t}ir({type:mn,name:"OpenTherm DHW",description:"Domestic hot water control"});let bn=class extends Yi{static async getStubConfig(t){const e=Object.keys(t.states),i=e.filter(t=>fn.includes(Ot(t))),r=e.filter(t=>ln.includes(Ot(t))),n=i.find(t=>t.includes("dhw_enable"))??i[0]??"",o=r.find(t=>t.includes("dhw"))??r[0]??"";return{type:`custom:${mn}`,dhw_enable_entity:n,dhw_setpoint_entity:o}}static async getConfigElement(){return await Promise.resolve().then(function(){return Un}),document.createElement(_n)}setConfig(t){this._config=yn(t)}getGridOptions(){return{columns:6,rows:4,min_rows:1}}get _dhwEnabled(){return"on"===this._entityState(this._config.dhw_enable_entity)?.state}get _dhwActive(){return!!this._config.dhw_active_entity&&"on"===this._entityState(this._config.dhw_active_entity)?.state}get _setpointValue(){return this._resolveEntityNumber(this._config.dhw_setpoint_entity,NaN)}get _sliderProps(){const t=this._config.dhw_setpoint_entity;return{min:this._entityAttr(t,"min")??30,max:this._entityAttr(t,"max")??60,step:this._entityAttr(t,"step")??.5}}get _dhwTemp(){return this._config.dhw_temp_entity?this._resolveEntityNumber(this._config.dhw_temp_entity,NaN):NaN}_titleEntity(){return this._config.dhw_enable_entity}_headerIconColor(){return this._dhwEnabled?"var(--rgb-state-climate-heat, 244,81,30)":"var(--rgb-disabled, 158,158,158)"}_renderHeaderBadges(){const t=Mi(this.hass);return z`
      <div class="badges">
        ${this._dhwActive?z`
          <eq-badge-info
            style="--badge-info-color: var(--rgb-state-climate-heat, 255, 152, 0)"
    ...
    `}_lastUpdatedEntity(){return this._config.dhw_setpoint_entity}_toggleDhw(){if(!this.hass)return;const{dhw_enable_entity:t}=this._config,e=Ot(t),i=this._dhwEnabled?"turn_off":"turn_on";this.hass.callService(e,i,{entity_id:t})}_setpointChanged(t){if(!this.hass)return;const e=t.target.value,i=parseFloat(e);if(isNaN(i))return;const r="input_number"===Ot(this._config.dhw_setpoint_entity)?"input_number":"number";this.hass.callService(r,"set_value",{entity_id:this._config.dhw_setpoint_entity,value:i})}static get styles(){return[super.styles,Ji,Vi,a`
      ...
      `]}render(){if(!this._config||!this.hass)return V;const t=Mi(this.hass),e=this._config,i=this._dhwEnabled,r=this._setpointValue,n=this._dhwTemp,o=e.dhw_temp_entity&&!isNaN(n),s=this._computeCardTitle("opentherm.dhw_card.default_title");return z`
      <ha-card>
    ...
    `}};bn=t([ht(mn)],bn);const vn="opentherm-efficiency-card",wn=rr(vn),xn=vr({type:br(),boiler_temp_entity:br(),return_temp_entity:br(),flame_entity:yr(br()),ch_active_entity:yr(br()),condensing_threshold:yr(gr()),hours:yr(gr()),name:yr(wr()),show_last_updated:yr(fr())});function En(t){return dr(t,xn),t}class $n{static async fetch(t,e,i){const r=new Date,n=new Date(r.getTime()-3600*i*1e3),o=e.join(","),s=`history/period/${n.toISOString()}?filter_entity_id=${o}&end_time=${r.toISOString()}&minimal_response=true&no_attributes=true`;try{const i=await t.callApi("GET",s),r={};for(let t=0;t<e.length;t++)r[e[t]]=i[t]??[];return r}catch{return Object.fromEntries(e.map(t=>[t,[]]))}}static countCycles(t){let e=0;for(let i=1;i<t.length;i++)"off"===t[i-1].state&&"on"===t[i].state&&e++;return e}static toRangeBarSeries(t,e){const i=[];for(let r=0;r<t.length;r++){const n=new Date(t[r].last_changed).getTime(),o=r+1<t.length?new Date(t[r+1].last_changed).getTime():e;i.push({x:"on"===t[r].state?"On":"Off",y:[n,o]})}return i}}ir({type:vn,name:"OpenTherm Efficiency",description:"Boiler condensing efficiency chart"});let Tn=class extends Ki{constructor(){super(...arguments),this._boilerHistory=[],this._returnHistory=[]}setConfig(t){this._config=En(t)}static async getConfigElement(){return await Promise.resolve().then(function(){return zn}),document.createElement(wn)}static async getStubConfig(t){const e=Object.keys(t.states),i=e.find(t=>t.includes("boiler")||t.includes("t_boiler"))??"",r=e.find(t=>t.includes("ret")||t.includes("return"))??"",n=e.find(t=>"binary_sensor"===Ot(t)&&t.includes("flame"))??"",o=e.find(t=>"binary_sensor"===Ot(t)&&(t.includes("ch_active")||t.includes("central_heating")))??"";return{type:`custom:${vn}`,boiler_temp_entity:i,return_temp_entity:r,flame_entity:n||void 0,ch_active_entity:o||void 0}}get _defaultThreshold(){return"°F"===this.hass?.config?.unit_system?.temperature?131:55}get _isChActive(){return this._config.ch_active_entity?"on"===this._entityState(this._config.ch_active_entity)?.state:!!this._config.flame_entity&&"on"===this._entityState(this._config.flame_entity)?.state}get _returnTemp(){return this._resolveEntityNumber(this._config.return_temp_entity,NaN)}get _isCondensing(){if(!this._isChActive)return!1;const t=this._config.condensing_threshold??this._defaultThreshold;return!isNaN(this._returnTemp)&&this._returnTemp<t}get _isHeatingTooHot(){if(!this._isChActive)return!1;const t=this._config.condensing_threshold??this._defaultThreshold;return!isNaN(this._returnTemp)&&this._returnTemp>=t}_titleEntity(){return this._config.boiler_temp_entity}_headerIconColor(){return this._isCondensing?"var(--rgb-success, 76,175,80)":this._isHeatingTooHot?"var(--rgb-state-climate-heat, 244,81,30)":"var(--rgb-disabled, 158,158,158)"}_renderHeaderBadges(){const t=Mi(this.hass);return z`
      <div class="badges">
    ...
    `}_onChartReconnected(){this._fetchHistory(),this._fetchTimer=setInterval(()=>this._fetchHistory(),6e4)}_onChartDisconnecting(){clearInterval(this._fetchTimer),this._fetchTimer=void 0}async _fetchHistory(){const t=this._config.hours??6,e=await $n.fetch(this.hass,[this._config.boiler_temp_entity,this._config.return_temp_entity],t);this._boilerHistory=e[this._config.boiler_temp_entity]??[],this._returnHistory=e[this._config.return_temp_entity]??[],this._updateChartConfig()}_toChartData(t,e){const i=t.map(t=>[new Date(t.last_changed).getTime(),parseFloat(t.state)]).filter(t=>!isNaN(t[1]));if(e){const t=this._resolveEntityNumber(e,NaN);isNaN(t)||i.push([Date.now(),t])}return i}_buildMarkLine(t){const e=this.hass?.config?.unit_system?.temperature??"°C";return{silent:!0,symbol:"none",lineStyle:{color:"rgba(76,175,80,0.5)",type:"dashed",width:1},data:[{yAxis:t,label:{formatter:`${Qt(t,this.hass?.locale,{maximumFractionDigits:0})}${e}`,fontSize:10,position:"insideEndTop"}}]}}_buildTooltipFormatter(){const t=this.hass?.config?.unit_system?.temperature??"°C",e=this.hass?.locale;return i=>{const r=this._formatChartTime(i[0].value[0]);return z`
        <span style="opacity:0.6">${r}</span><br/>
        ${i.map(i=>z`
          <ha-chart-tooltip-marker .color=${i.color}></ha-chart-tooltip-marker>${i.seriesName}: <b>${Qt(i.value[1],e,{minimumFractionDigits:1,maximumFractionDigits:1})}${t}</b><br/>
        `)}
      `}}_buildEChartOptions(){const t=this._config.condensing_threshold??this._defaultThreshold,e=Mi(this.hass),i=qi(this,"heating"),r=qi(this,"cooling");return{options:{animation:!1,xAxis:{type:"time",axisTick:{show:!1},axisLine:{show:!1},axisLabel:{fontSize:10,hideOverlap:!0}},yAxis:{type:"value",name:`${e("opentherm.efficiency_card.temp_axis")} (${this.hass?.config?.unit_system?.temperature??"°C"})`,axisLabel:{fontSize:10,formatter:t=>Qt(t,this.hass?.locale,{maximumFractionDigits:1})}},grid:{top:10,right:10,bottom:25,left:40},tooltip:{trigger:"axis",formatter:this._buildTooltipFormatter()},legend:{show:!1}},data:[{type:"line",name:"Flow",data:this._toChartData(this._boilerHistory,this._config.boiler_temp_entity),smooth:!0,showSymbol:!1,lineStyle:{width:2},itemStyle:{color:i},markLine:this._buildMarkLine(t)},{type:"line",name:"Return",data:this._toChartData(this._returnHistory,this._config.return_temp_entity),smooth:!0,showSymbol:!1,lineStyle:{width:1.5},itemStyle:{color:r}}]}}_lastUpdatedEntity(){return this._config.boiler_temp_entity}static get styles(){return[super.styles,Ji,Vi,a`
    ...
    `}};Tn=t([ht(vn)],Tn);const Cn="opentherm-modulation-card",Sn=rr(Cn),Hn=vr({type:br(),modulation_entity:br(),max_modulation_entity:br(),flame_entity:br(),hours:yr(gr()),name:yr(wr()),show_last_updated:yr(fr())});function An(t){return dr(t,Hn),t}let Nn=class extends lt{constructor(){super(...arguments),this.segments=[],this.startTime=0,this.endTime=0,this.onColor="#f97316",this.offColor="rgba(128,128,128,0.15)",this.barHeight=16}static get styles(){return a`
      :host { display: block; }
      ha-chart-base {
        display: block;
    ...
    `}render(){const t=this.segments.map(t=>[0,t.start,t.end,"on"===t.state?this.onColor:this.offColor]),e=this.onColor,i=this.barHeight,r={xAxis:{type:"time",min:this.startTime,max:this.endTime,axisTick:{show:!1},axisLine:{show:!1},splitLine:{show:!1},axisLabel:{fontSize:10,hideOverlap:!0}},yAxis:{type:"category",show:!1,data:["flame"]},grid:{top:5,bottom:20,left:0,right:0},tooltip:{show:!0,trigger:"item",confine:!0,position:"bottom",formatter:t=>{const i=t.value,r=i[1],n=i[2],o=i[3],s=o===e?"ON":"OFF",a=Math.round((n-r)/1e3),l=a>=60?`${Math.floor(a/60)}m ${a%60}s`:`${a}s`,c=Yt(new Date(r),this.hass.locale);return z`
      ...
      <ha-chart-base
        ...
        hide-reset-button
      ></ha-chart-base>
    `}};t([pt({attribute:!1})],Nn.prototype,"hass",void 0),t([pt({attribute:!1})],Nn.prototype,"segments",void 0),t([pt({attribute:!1})],Nn.prototype,"startTime",void 0),t([pt({attribute:!1})],Nn.prototype,"endTime",void 0),t([pt({attribute:!1})],Nn.prototype,"onColor",void 0),t([pt({attribute:!1})],Nn.prototype,"offColor",void 0),t([pt({type:Number})],Nn.prototype,"barHeight",void 0),Nn=t([ht("eq-binary-timeline")],Nn);ir({type:Cn,name:"OpenTherm Modulation",description:"Boiler modulation and short-cycle diagnostics"});let Dn=class extends Yi{constructor(){super(...arguments),this._flameHistory=[],this._cyclesPerHour=0,this._timelineCache=null,this._onMaxModulationChange=t=>{const e=parseFloat(t.target.value);isNaN(e)||this._setMaxModulation(e)}}setConfig(t){this._config=An(t)}static async getConfigElement(){return await Promise.resolve().then(function(){return Vn}),document.createElement(Sn)}static async getStubConfig(t){const e=Object.keys(t.states),i=e.find(t=>t.includes("modulation")||t.includes("rel_mod"))??"",r=e.find(t=>t.includes("max_rel_mod")||t.includes("max_modulation"))??"",n=e.find(t=>t.includes("flame"))??"";return{type:`custom:${Cn}`,modulation_entity:i,max_modulation_entity:r,flame_entity:n}}getGridOptions(){return{columns:6,rows:4,min_rows:3}}get _flameOn(){return"on"===this._entityState(this._config.flame_entity)?.state}_titleEntity(){return this._config.modulation_entity}_headerIconColor(){return this._flameOn?"var(--rgb-state-climate-heat, 244,81,30)":"var(--rgb-disabled, 158,158,158)"}_renderHeaderBadges(){const t=Mi(this.hass),e=this._cyclesPerHour,i=e>6;return z`
      <div class="badges">
        ${e>0?z`
    ...
    `}connectedCallback(){super.connectedCallback(),this._fetchHistory(),this._fetchTimer=setInterval(()=>this._fetchHistory(),3e4)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this._fetchTimer),this._fetchTimer=void 0}async _fetchHistory(){if(!this.hass)return;const t=this._config.hours??1,e=await $n.fetch(this.hass,[this._config.flame_entity],t);this._flameHistory=e[this._config.flame_entity]??[];const i=Date.now()-36e5,r=this._flameHistory.filter(t=>new Date(t.last_changed).getTime()>=i);this._cyclesPerHour=$n.countCycles(r),this._timelineCache=this._buildTimelineData()}async _setMaxModulation(t){if(!this.hass)return;const e=this._config.max_modulation_entity;try{await this.hass.callService(Ot(e),"set_value",{entity_id:e,value:t})}catch(t){console.warn("Failed to set max modulation:",t)}}_buildTimelineData(){const t=this._config.hours??1,e=Date.now(),i=e-3600*t*1e3,r=e,n=[],o=this._flameHistory.filter(t=>{const e=new Date(t.last_changed).getTime();return e>=i&&e<=r});for(let t=0;t<o.length;t++){const e=new Date(o[t].last_changed).getTime(),i=t+1<o.length?new Date(o[t+1].last_changed).getTime():r;n.push({start:e,end:i,state:"on"===o[t].state?"on":"off"})}return{segments:n,startTime:i,endTime:e}}_lastUpdatedEntity(){return this._config.flame_entity}static get styles(){return[super.styles,Ji,Vi,a`
      ...
      `]}render(){if(!this._config||!this.hass)return V;const t=Mi(this.hass),e=this._config,i=this._resolveEntityNumber(e.modulation_entity,0),r=this._resolveEntityNumber(e.max_modulation_entity,100),n=this._entityAttr(e.max_modulation_entity,"min")??0,o=this._entityAttr(e.max_modulation_entity,"max")??100,s=this._computeCardTitle("opentherm.modulation_card.default_title"),{segments:a,startTime:l,endTime:c}=this._timelineCache??this._buildTimelineData(),h=Qt(i,this.hass.locale,{maximumFractionDigits:0}),u=Qt(r,this.hass.locale,{maximumFractionDigits:0});return z`
      <ha-card>
    ...
    `}};t([mt()],Dn.prototype,"_cyclesPerHour",void 0),Dn=t([ht(Cn)],Dn),console.info("%c EQUITHERM-CARDS %c 1.6.1 ","color: white; background: #f97316; font-weight: bold;","color: #f97316; background: white; font-weight: bold;");const Pn={entity:function(t,e={}){return{name:t,required:e.required??!0,selector:{entity:{domain:e.domain,device_class:e.device_class}}}},number:function(t,e,i,r=1,n={}){return{name:t,required:n.required??!1,...void 0!==n.default&&{default:n.default},selector:{number:{min:e,max:i,step:r,mode:n.mode??"box",unit_of_measurement:n.unit_of_measurement}}}},text:function(t,e=!1){return{name:t,required:e,selector:{text:{}}}},entityName:function(t,e){return{name:t,selector:{entity_name:{}},context:e}},grid:function(t){return{type:"grid",name:"",schema:t}},expandable:function(t,e,i){return{type:"expandable",flatten:!0,title:t,icon:e,name:"",schema:i}}};let kn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt(t=>{const e=Mi(this.hass);return[Pn.entity("climate_entity",{domain:"climate"}),Pn.entityName("name",{entity:"climate_entity"}),Pn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),Pn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...t?[Pn.expandable(e("editor.tuning"),"mdi:tune-variant",[Pn.entity("hc_entity",{domain:["number","input_number"]}),Pn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],Pn.expandable(e("editor.optional"),"mdi:connection",[Pn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),Pn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),Pn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("wws_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("pid_correction_entity",{domain:["sensor","input_number"],device_class:"temperature",required:!1})]),Pn.expandable(e("editor.curve_parameters"),"mdi:chart-bell-curve-cumulative",[Pn.entity("hc_entity",{domain:["number","input_number"],required:!1}),Pn.entity("shift_entity",{domain:["number","input_number"],required:!1}),Pn.entity("n_entity",{domain:["number","input_number"],required:!1})])]})}setConfig(t){this._config={...t}}_validate(t){Er(t)}_getSchema(){return this._schemaMemo(!!this._config.tunable)}};kn=t([ht(Cr)],kn);var Mn=Object.freeze({__proto__:null,get StatusCardEditor(){return kn}});let Bn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt((t,e,i)=>{const r=this.hass?.config?.unit_system?.temperature??"°C",n=t=>Math.round(10*Et(t,i))/10,o=t=>Math.round(10*Tt(t,i))/10,s=Mi(this.hass);return[Pn.entity("climate_entity",{domain:"climate"}),Pn.entityName("name",{entity:"climate_entity"}),Pn.entity("outdoor_entity",{domain:["sensor","input_number"],device_class:"temperature"}),Pn.entity("curve_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),Pn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"tunable",selector:{boolean:{}},default:!1},{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},...e?[Pn.expandable(s("editor.tuning"),"mdi:tune-variant",[Pn.entity("hc_entity",{domain:["number","input_number"]}),Pn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],Pn.expandable(s("editor.optional"),"mdi:connection",[Pn.entity("pid_output_entity",{domain:["sensor"],device_class:"temperature",required:!1}),Pn.entity("rate_limiting_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),Pn.expandable(s("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[Pn.entity("hc_entity",{domain:"number"}),Pn.entity("n_entity",{domain:"number"}),Pn.entity("shift_entity",{domain:"number"}),Pn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),Pn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[Pn.grid([Pn.number("hc",.5,3,.1,{default:.9}),Pn.number("n",1,2,.05,{default:1.25})]),Pn.number("shift",o(-15),o(15),1,{unit_of_measurement:r,default:o(0)}),Pn.grid([Pn.number("min_flow",n(15),n(35),1,{unit_of_measurement:r,default:n(20)}),Pn.number("max_flow",n(50),n(90),1,{unit_of_measurement:r,default:n(70)})])]]),Pn.expandable(s("editor.display_range"),"mdi:arrow-expand-horizontal",[Pn.grid([Pn.number("t_out_min",n(-30),n(5),1,{unit_of_measurement:r,default:n(-20)}),Pn.number("t_out_max",n(0),n(30),1,{unit_of_measurement:r,default:n(20)})])]),Pn.expandable(s("editor.appearance"),"mdi:palette-outline",[{name:"gradient_warm_color",selector:{ui_color:{}}},{name:"gradient_cool_color",selector:{ui_color:{}}}])]})}setConfig(t){this._config={...t}}_validate(t){Kr(t)}_transformConfig(t){if(!xt(this.hass))return t;const e={...t};null!=e.shift&&(e.shift=Ct(e.shift,!0));for(const t of["min_flow","max_flow","t_out_min","t_out_max"])null!=e[t]&&(e[t]=$t(e[t],!0));return e}_getDisplayConfig(){if(!xt(this.hass))return this._config;const t={...this._config};null!=t.shift&&(t.shift=Math.round(10*Tt(t.shift,!0))/10);for(const e of["min_flow","max_flow","t_out_min","t_out_max"])null!=t[e]&&(t[e]=Math.round(10*Et(t[e],!0))/10);return t}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable,xt(this.hass))}};Bn=t([ht(Vr)],Bn);var On=Object.freeze({__proto__:null,get EquithermCurveCardEditor(){return Bn}});let In=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt((t,e)=>{const i=Mi(this.hass);return[Pn.entity("weather_entity",{domain:"weather"}),Pn.entity("climate_entity",{domain:"climate"}),Pn.entityName("name",{entity:"climate_entity"}),Pn.entity("flow_entity",{domain:["sensor","number","input_number"],device_class:"temperature"}),{name:"show_last_updated",selector:{boolean:{}},default:!1},{name:"show_kpi_footer",selector:{boolean:{}},default:!0},{name:"show_params_footer",selector:{boolean:{}},default:!0},{name:"tunable",selector:{boolean:{}},default:!1},...e?[Pn.expandable(i("editor.tuning"),"mdi:tune-variant",[Pn.entity("hc_entity",{domain:["number","input_number"]}),Pn.entity("shift_entity",{domain:["number","input_number"]}),{name:"recalculate_service",selector:{text:{}}}])]:[],Pn.expandable(i("editor.optional"),"mdi:connection",[Pn.entity("outdoor_entity",{domain:["sensor","number","input_number"],device_class:"temperature",required:!1}),Pn.entity("pid_active_entity",{domain:["binary_sensor"],required:!1}),Pn.entity("wws_entity",{domain:["binary_sensor"],required:!1})]),Pn.expandable(i("editor.forecast_settings"),"mdi:clock-outline",[Pn.number("hours",1,48,1,{unit_of_measurement:"h",default:24})]),Pn.expandable(i("editor.curve_parameters"),"mdi:chart-bell-curve",[{name:"curve_from_entities",selector:{boolean:{}}},...t?[Pn.entity("hc_entity",{domain:"number"}),Pn.entity("n_entity",{domain:"number"}),Pn.entity("shift_entity",{domain:"number"}),Pn.entity("min_flow_entity",{domain:["sensor","number"],required:!1}),Pn.entity("max_flow_entity",{domain:["sensor","number"],required:!1})]:[Pn.grid([Pn.number("hc",.5,3,.1,{default:.9}),Pn.number("n",1,2,.05,{default:1.25})]),Pn.number("shift",-15,15,1,{unit_of_measurement:"°C",default:0}),Pn.grid([Pn.number("min_flow",15,35,1,{unit_of_measurement:"°C",default:20}),Pn.number("max_flow",50,90,1,{unit_of_measurement:"°C",default:70})])]])]})}setConfig(t){this._config={...t}}_validate(t){nn(t)}_getSchema(){return this._schemaMemo(!!this._config.curve_from_entities,!!this._config.tunable)}};In=t([ht(tn)],In);var Fn=Object.freeze({__proto__:null,get EquithermForecastCardEditor(){return In}});let Rn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt(()=>{const t=Mi(this.hass);return[Pn.entity("boiler_temp_entity",{domain:["sensor","input_number"],device_class:"temperature"}),Pn.entityName("name",{entity:"boiler_temp_entity"}),Pn.entity("return_temp_entity",{domain:["sensor","input_number"],device_class:"temperature"}),Pn.entity("flame_entity",{domain:["binary_sensor","input_boolean"]}),{name:"show_last_updated",selector:{boolean:{}}},Pn.expandable(t("editor.optional"),"mdi:connection",[Pn.entity("setpoint_entity",{domain:["sensor","number","input_number"],device_class:"temperature",required:!1}),Pn.entity("modulation_entity",{domain:["sensor","input_number"],required:!1}),Pn.entity("ch_active_entity",{domain:["binary_sensor","input_boolean"],required:!1}),Pn.entity("dhw_active_entity",{domain:["binary_sensor","input_boolean"],required:!1})])]})}setConfig(t){this._config={...t}}_validate(t){dn(t)}_getSchema(){return this._schemaMemo()}};Rn=t([ht(hn)],Rn);var Ln=Object.freeze({__proto__:null,get OtStatusCardEditor(){return Rn}});let qn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt(()=>{const t=Mi(this.hass);return[Pn.entity("dhw_enable_entity",{domain:["switch","input_boolean"]}),Pn.entityName("name",{entity:"dhw_enable_entity"}),Pn.entity("dhw_setpoint_entity",{domain:["number","input_number"]}),{name:"show_last_updated",selector:{boolean:{}}},Pn.expandable(t("editor.optional"),"mdi:connection",[Pn.entity("dhw_active_entity",{domain:["binary_sensor","input_boolean"],required:!1}),Pn.entity("dhw_temp_entity",{domain:["sensor","input_number"],required:!1})])]})}setConfig(t){this._config={...t}}_validate(t){yn(t)}_getSchema(){return this._schemaMemo()}};qn=t([ht(_n)],qn);var Un=Object.freeze({__proto__:null,get OtDhwCardEditor(){return qn}});let Gn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt(()=>{const t=Mi(this.hass);return[Pn.entity("boiler_temp_entity",{domain:["sensor","input_number"]}),Pn.entityName("name",{entity:"boiler_temp_entity"}),Pn.entity("return_temp_entity",{domain:["sensor","input_number"]}),Pn.expandable(t("editor.optional"),"mdi:connection",[Pn.entity("flame_entity",{domain:["binary_sensor","input_boolean"]}),Pn.entity("ch_active_entity",{domain:["binary_sensor","input_boolean"]}),Pn.number("condensing_threshold",30,80,1,{unit_of_measurement:"°C"}),Pn.number("hours",1,48,1),{name:"show_last_updated",selector:{boolean:{}}}])]})}setConfig(t){this._config={...t}}_validate(t){En(t)}_getSchema(){return this._schemaMemo()}};Gn=t([ht(wn)],Gn);var zn=Object.freeze({__proto__:null,get OtEfficiencyCardEditor(){return Gn}});let jn=class extends Zi{constructor(){super(...arguments),this._schemaMemo=Xt(()=>{const t=Mi(this.hass);return[Pn.entity("modulation_entity",{domain:["sensor","input_number"]}),Pn.entity("max_modulation_entity",{domain:["number","input_number"]}),Pn.entity("flame_entity",{domain:["binary_sensor","input_boolean"]}),Pn.entityName("name",{entity:"modulation_entity"}),{name:"show_last_updated",selector:{boolean:{}}},Pn.expandable(t("editor.optional"),"mdi:tune",[{name:"hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}}])]})}setConfig(t){this._config={...t}}_validate(t){An(t)}_getSchema(){return this._schemaMemo()}};jn=t([ht(Sn)],jn);var Vn=Object.freeze({__proto__:null,get OtModulationCardEditor(){return jn}});
